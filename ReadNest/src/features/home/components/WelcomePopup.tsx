        ...
        <div className="auto-scroll max-h-[70vh] overflow-y-auto bg-white rounded-b-lg shadow-lg">
          <div className="text-gray-800 px-7">
            <div className="border-t border-gray-200 py-2">
              ...
              <p className="mb-6">
                Tạo ra một nền tảng thân thiện với người dùng, cho phép độc giả
                dễ dàng tìm kiếm, chia sẻ và đóng góp các đánh giá (review) về
                những cuốn sách mà họ đã đọc. Website sẽ đóng vai trò như một
                cộng đồng trao đổi thông tin sách, giúp người dùng khám phá thêm
                nhiều đầu sách hay thông qua trải nghiệm và nhận xét từ những
                người đọc khác.
              </p>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-m">
                        Đây là phiên bản đầu tiên được triển khai chính thức của
                        hệ thống. Phiên bản 1.0.0 tập trung vào các chức năng
                        cốt lõi nhằm mang lại trải nghiệm ban đầu cho người dùng
                        trong việc khám phá và chia sẻ về các đầu sách yêu
                        thích.
                      </p>
                    </div>
                  </div>
