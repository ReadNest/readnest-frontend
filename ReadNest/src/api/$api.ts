...
const api = <T>({ baseURL, fetch }: AspidaClient<T>) => {
  ...
  const PATH2 = '/api/v1/ChatMessages/get-chatter-by-user-id';
  const PATH3 = '/api/v1/ChatMessages/get-chatter-by-user-name';
  const PATH4 = '/api/v1/ChatMessages/get-full-conversation';
  const PATH5 = '/api/v1/Comment';
  const PATH6 = '/api/v1/Comment/like';
  const PATH7 = '/api/v1/Comment/pending-reported-comments';
  const PATH8 = '/api/v1/Comment/top-3-most-liked-comments';
  const PATH9 = '/api/v1/Comment/top-3-recent-comments';
  const PATH10 = '/api/v1/CommentReport';
  const PATH11 = '/api/v1/CommentReport/approve';
  const PATH12 = '/api/v1/CommentReport/reject';
  const PATH13 = '/api/v1/Event';
  const PATH14 = '/rewards';
  const PATH15 = '/api/v1/Event/all';
  const PATH16 = '/api/v1/Event/all-paging';
  const PATH17 = '/api/v1/Event/current';
  const PATH18 = '/api/v1/Leaderboard/rank';
  const PATH19 = '/api/v1/Leaderboard/recalculate-scores';
  const PATH20 = '/api/v1/Leaderboard/top';
  const PATH21 = '/api/v1/Leaderboard/top-by-time-range';
  const PATH22 = '/api/v1/Leaderboard/user';
  const PATH23 = '/api/v1/UserBadges/assign-badge-to-all-users';
  const PATH24 = '/api/v1/UserBadges/select-user-badge';
  const PATH25 = '/api/v1/UserBadges/set-all-badges-active';
  const PATH26 = '/api/v1/auth/login';
  const PATH27 = '/api/v1/auth/refresh-token';
  const PATH28 = '/api/v1/auth/register';
  const PATH29 = '/api/v1/books';
  const PATH30 = '/affiliate-links';
  const PATH31 = '/api/v1/books/all';
  const PATH32 = '/api/v1/books/filter';
  const PATH33 = '/api/v1/books/search';
  const PATH34 = '/api/v1/categories';
  const PATH35 = '/api/v1/categories/all';
  const PATH36 = '/api/v1/favoriteBooks/favorites';
  const PATH37 = '/api/v1/favoriteBooks/toggle';
  const PATH38 = '/api/v1/features';
  const PATH39 = '/api/v1/features/all';
  const PATH40 = '/api/v1/packages';
  const PATH41 = '/api/v1/payment/init-webhook';
  const PATH42 = '/api/v1/payment/payment-links';
  const PATH43 = '/api/v1/payment/webhook';
  const PATH44 = '/api/v1/posts';
  const PATH45 = '/api/v1/posts/book';
  const PATH46 = '/api/v1/posts/filter';
  const PATH47 = '/api/v1/posts/increase-views';
  const PATH48 = '/api/v1/posts/like';
  const PATH49 = '/api/v1/posts/top-liked';
  const PATH50 = '/api/v1/posts/top-viewed';
  const PATH51 = '/api/v1/posts/user';
  const PATH52 = '/api/v1/trading-posts';
  const PATH53 = '/trading-requests';
  const PATH54 = '/api/v1/trading-posts/top';
  const PATH55 = '/api/v1/trading-posts/v2';
  const PATH56 = '/api/v1/trading-requests';
  const PATH57 = '/api/v1/users';
  const PATH58 = '/api/v1/users/profile';
  const PATH59 = '/api/v1/users/username';
  const GET = 'GET';
  const POST = 'POST';
  const PUT = 'PUT';
  const DELETE = 'DELETE';
      ...
      v1: {
        ...
        Comment: {
          ...
          like: {
            ...
            post: (option: { body: Methods_13ir33a['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods_13ir33a['post']['resBody'], BasicHeaders, Methods_13ir33a['post']['status']>(prefix, PATH6, POST, option).json(),
            /**
             * @returns OK
             */
            $post: (option: { body: Methods_13ir33a['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods_13ir33a['post']['resBody'], BasicHeaders, Methods_13ir33a['post']['status']>(prefix, PATH6, POST, option).json().then(r => r.body),
            $path: () => `${prefix}${PATH6}`,
          },
          pending_reported_comments: {
             ...
             */
            get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_idg5yl['get']['resBody'], BasicHeaders, Methods_idg5yl['get']['status']>(prefix, PATH7, GET, option).json(),
            /**
             * @returns OK
             */
            $get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_idg5yl['get']['resBody'], BasicHeaders, Methods_idg5yl['get']['status']>(prefix, PATH7, GET, option).json().then(r => r.body),
            $path: () => `${prefix}${PATH7}`,
          },
          top_3_most_liked_comments: {
             ...
             */
            get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_b4lw45['get']['resBody'], BasicHeaders, Methods_b4lw45['get']['status']>(prefix, PATH8, GET, option).json(),
            /**
             * @returns OK
             */
            $get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_b4lw45['get']['resBody'], BasicHeaders, Methods_b4lw45['get']['status']>(prefix, PATH8, GET, option).json().then(r => r.body),
            $path: () => `${prefix}${PATH8}`,
          },
          ...
          post: (option: { body: Methods_e8ufco['post']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_e8ufco['post']['resBody'], BasicHeaders, Methods_e8ufco['post']['status']>(prefix, PATH5, POST, option).json(),
          /**
           * @returns OK
           */
          $post: (option: { body: Methods_e8ufco['post']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_e8ufco['post']['resBody'], BasicHeaders, Methods_e8ufco['post']['status']>(prefix, PATH5, POST, option).json().then(r => r.body),
          /**
           * @returns OK
           */
          put: (option: { body: Methods_e8ufco['put']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_e8ufco['put']['resBody'], BasicHeaders, Methods_e8ufco['put']['status']>(prefix, PATH5, PUT, option).json(),
          /**
           * @returns OK
           */
          $put: (option: { body: Methods_e8ufco['put']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_e8ufco['put']['resBody'], BasicHeaders, Methods_e8ufco['put']['status']>(prefix, PATH5, PUT, option).json().then(r => r.body),
          $path: () => `${prefix}${PATH5}`,
        },
        CommentReport: {
          approve: {
          ...
          post: (option: { body: Methods_8p99oi['post']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_8p99oi['post']['resBody'], BasicHeaders, Methods_8p99oi['post']['status']>(prefix, PATH10, POST, option).json(),
          /**
           * @returns OK
           */
          $post: (option: { body: Methods_8p99oi['post']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_8p99oi['post']['resBody'], BasicHeaders, Methods_8p99oi['post']['status']>(prefix, PATH10, POST, option).json().then(r => r.body),
          $path: () => `${prefix}${PATH10}`,
        },
        Event: {
          _eventId: (val3: string) => {
            ...
            return {
              rewards: {
                 ...
                 */
                get: (option?: { config?: T | undefined } | undefined) =>
                  fetch<Methods_vasura['get']['resBody'], BasicHeaders, Methods_vasura['get']['status']>(prefix, `${prefix3}${PATH14}`, GET, option).json(),
                /**
                 * @returns OK
                 */
                $get: (option?: { config?: T | undefined } | undefined) =>
                  fetch<Methods_vasura['get']['resBody'], BasicHeaders, Methods_vasura['get']['status']>(prefix, `${prefix3}${PATH14}`, GET, option).json().then(r => r.body),
          ...
          all: {
             ...
             */
            get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_4mqld1['get']['resBody'], BasicHeaders, Methods_4mqld1['get']['status']>(prefix, PATH15, GET, option).json(),
            /**
             * @returns OK
             */
            $get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_4mqld1['get']['resBody'], BasicHeaders, Methods_4mqld1['get']['status']>(prefix, PATH15, GET, option).json().then(r => r.body),
            $path: () => `${prefix}${PATH15}`,
          },
          all_paging: {
            /**
            ...
            get: (option?: { query?: Methods_qj9hr8['get']['query'] | undefined, config?: T | undefined } | undefined) =>
              fetch<Methods_qj9hr8['get']['resBody'], BasicHeaders, Methods_qj9hr8['get']['status']>(prefix, PATH16, GET, option).json(),
            /**
             * @returns OK
             */
            $get: (option?: { query?: Methods_qj9hr8['get']['query'] | undefined, config?: T | undefined } | undefined) =>
              fetch<Methods_qj9hr8['get']['resBody'], BasicHeaders, Methods_qj9hr8['get']['status']>(prefix, PATH16, GET, option).json().then(r => r.body),
          ...
          current: {
             ...
             */
            get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_dc508v['get']['resBody'], BasicHeaders, Methods_dc508v['get']['status']>(prefix, PATH17, GET, option).json(),
            /**
             * @returns OK
             */
            $get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_dc508v['get']['resBody'], BasicHeaders, Methods_dc508v['get']['status']>(prefix, PATH17, GET, option).json().then(r => r.body),
            $path: () => `${prefix}${PATH17}`,
          },
          /**
           * @returns OK
          ...
          post: (option: { body: Methods_1vez6b1['post']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_1vez6b1['post']['resBody'], BasicHeaders, Methods_1vez6b1['post']['status']>(prefix, PATH13, POST, option).json(),
          /**
           * @returns OK
           */
          $post: (option: { body: Methods_1vez6b1['post']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_1vez6b1['post']['resBody'], BasicHeaders, Methods_1vez6b1['post']['status']>(prefix, PATH13, POST, option).json().then(r => r.body),
          /**
           * @returns OK
           */
          put: (option: { body: Methods_1vez6b1['put']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_1vez6b1['put']['resBody'], BasicHeaders, Methods_1vez6b1['put']['status']>(prefix, PATH13, PUT, option).json(),
          /**
           * @returns OK
           */
          $put: (option: { body: Methods_1vez6b1['put']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_1vez6b1['put']['resBody'], BasicHeaders, Methods_1vez6b1['put']['status']>(prefix, PATH13, PUT, option).json().then(r => r.body),
          $path: () => `${prefix}${PATH13}`,
        },
        Leaderboard: {
          rank: {
          ...
          top_by_time_range: {
            ...
            get: (option?: { query?: Methods_s81qhi['get']['query'] | undefined, config?: T | undefined } | undefined) =>
              fetch<Methods_s81qhi['get']['resBody'], BasicHeaders, Methods_s81qhi['get']['status']>(prefix, PATH21, GET, option).json(),
            /**
             * @returns OK
             */
            $get: (option?: { query?: Methods_s81qhi['get']['query'] | undefined, config?: T | undefined } | undefined) =>
              fetch<Methods_s81qhi['get']['resBody'], BasicHeaders, Methods_s81qhi['get']['status']>(prefix, PATH21, GET, option).json().then(r => r.body),
        ...
        UserBadges: {
          assign_badge_to_all_users: {
            ...
            post: (option?: { query?: Methods_gpznh7['post']['query'] | undefined, config?: T | undefined } | undefined) =>
              fetch<Methods_gpznh7['post']['resBody'], BasicHeaders, Methods_gpznh7['post']['status']>(prefix, PATH23, POST, option).json(),
            /**
             * @returns OK
             */
            $post: (option?: { query?: Methods_gpznh7['post']['query'] | undefined, config?: T | undefined } | undefined) =>
              fetch<Methods_gpznh7['post']['resBody'], BasicHeaders, Methods_gpznh7['post']['status']>(prefix, PATH23, POST, option).json().then(r => r.body),
          ...
          select_user_badge: {
            ...
            post: (option?: { query?: Methods_zuqg05['post']['query'] | undefined, config?: T | undefined } | undefined) =>
              fetch<Methods_zuqg05['post']['resBody'], BasicHeaders, Methods_zuqg05['post']['status']>(prefix, PATH24, POST, option).json(),
            /**
             * @returns OK
             */
            $post: (option?: { query?: Methods_zuqg05['post']['query'] | undefined, config?: T | undefined } | undefined) =>
              fetch<Methods_zuqg05['post']['resBody'], BasicHeaders, Methods_zuqg05['post']['status']>(prefix, PATH24, POST, option).json().then(r => r.body),
          ...
          set_all_badges_active: {
            ...
            post: (option?: { query?: Methods_b7a7g9['post']['query'] | undefined, config?: T | undefined } | undefined) =>
              fetch<Methods_b7a7g9['post']['resBody'], BasicHeaders, Methods_b7a7g9['post']['status']>(prefix, PATH25, POST, option).json(),
            /**
             * @returns OK
             */
            $post: (option?: { query?: Methods_b7a7g9['post']['query'] | undefined, config?: T | undefined } | undefined) =>
              fetch<Methods_b7a7g9['post']['resBody'], BasicHeaders, Methods_b7a7g9['post']['status']>(prefix, PATH25, POST, option).json().then(r => r.body),
        ...
        auth: {
          login: {
            ...
            post: (option: { body: Methods_9wu66v['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods_9wu66v['post']['resBody'], BasicHeaders, Methods_9wu66v['post']['status']>(prefix, PATH26, POST, option).json(),
            /**
             * @returns OK
             */
            $post: (option: { body: Methods_9wu66v['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods_9wu66v['post']['resBody'], BasicHeaders, Methods_9wu66v['post']['status']>(prefix, PATH26, POST, option).json().then(r => r.body),
            $path: () => `${prefix}${PATH26}`,
          },
          refresh_token: {
            /**
            ...
            post: (option: { body: Methods_1eq60rt['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods_1eq60rt['post']['resBody'], BasicHeaders, Methods_1eq60rt['post']['status']>(prefix, PATH27, POST, option).json(),
            /**
             * @returns OK
             */
            $post: (option: { body: Methods_1eq60rt['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods_1eq60rt['post']['resBody'], BasicHeaders, Methods_1eq60rt['post']['status']>(prefix, PATH27, POST, option).json().then(r => r.body),
            $path: () => `${prefix}${PATH27}`,
          },
          register: {
            /**
            ...
            post: (option: { body: Methods_1p8w04r['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods_1p8w04r['post']['resBody'], BasicHeaders, Methods_1p8w04r['post']['status']>(prefix, PATH28, POST, option).json(),
            /**
             * @returns OK
             */
            $post: (option: { body: Methods_1p8w04r['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods_1p8w04r['post']['resBody'], BasicHeaders, Methods_1p8w04r['post']['status']>(prefix, PATH28, POST, option).json().then(r => r.body),
            $path: () => `${prefix}${PATH28}`,
          },
        },
        books: {
            ...
            return {
              affiliate_links: {
                ...
                post: (option: { body: Methods_1m0b8n6['post']['reqBody'], config?: T | undefined }) =>
                  fetch<Methods_1m0b8n6['post']['resBody'], BasicHeaders, Methods_1m0b8n6['post']['status']>(prefix, `${prefix3}${PATH30}`, POST, option).json(),
                /**
                 * @returns OK
                 */
                $post: (option: { body: Methods_1m0b8n6['post']['reqBody'], config?: T | undefined }) =>
                  fetch<Methods_1m0b8n6['post']['resBody'], BasicHeaders, Methods_1m0b8n6['post']['status']>(prefix, `${prefix3}${PATH30}`, POST, option).json().then(r => r.body),
          ...
          all: {
             ...
             */
            get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_2ssmp3['get']['resBody'], BasicHeaders, Methods_2ssmp3['get']['status']>(prefix, PATH31, GET, option).json(),
            /**
             * @returns OK
             */
            $get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_2ssmp3['get']['resBody'], BasicHeaders, Methods_2ssmp3['get']['status']>(prefix, PATH31, GET, option).json().then(r => r.body),
            $path: () => `${prefix}${PATH31}`,
          },
          filter: {
            /**
            ...
            get: (option?: { query?: Methods_etv2da['get']['query'] | undefined, config?: T | undefined } | undefined) =>
              fetch<Methods_etv2da['get']['resBody'], BasicHeaders, Methods_etv2da['get']['status']>(prefix, PATH32, GET, option).json(),
            /**
             * @returns OK
             */
            $get: (option?: { query?: Methods_etv2da['get']['query'] | undefined, config?: T | undefined } | undefined) =>
              fetch<Methods_etv2da['get']['resBody'], BasicHeaders, Methods_etv2da['get']['status']>(prefix, PATH32, GET, option).json().then(r => r.body),
          ...
          search: {
            ...
            get: (option?: { query?: Methods_cyey74['get']['query'] | undefined, config?: T | undefined } | undefined) =>
              fetch<Methods_cyey74['get']['resBody'], BasicHeaders, Methods_cyey74['get']['status']>(prefix, PATH33, GET, option).json(),
            /**
             * @returns OK
             */
            $get: (option?: { query?: Methods_cyey74['get']['query'] | undefined, config?: T | undefined } | undefined) =>
              fetch<Methods_cyey74['get']['resBody'], BasicHeaders, Methods_cyey74['get']['status']>(prefix, PATH33, GET, option).json().then(r => r.body),
          ...
          get: (option?: { query?: Methods_1jq8r4r['get']['query'] | undefined, config?: T | undefined } | undefined) =>
            fetch<Methods_1jq8r4r['get']['resBody'], BasicHeaders, Methods_1jq8r4r['get']['status']>(prefix, PATH29, GET, option).json(),
          /**
           * @returns OK
           */
          $get: (option?: { query?: Methods_1jq8r4r['get']['query'] | undefined, config?: T | undefined } | undefined) =>
            fetch<Methods_1jq8r4r['get']['resBody'], BasicHeaders, Methods_1jq8r4r['get']['status']>(prefix, PATH29, GET, option).json().then(r => r.body),
          /**
           * @returns OK
           */
          post: (option: { body: Methods_1jq8r4r['post']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_1jq8r4r['post']['resBody'], BasicHeaders, Methods_1jq8r4r['post']['status']>(prefix, PATH29, POST, option).json(),
          /**
           * @returns OK
           */
          $post: (option: { body: Methods_1jq8r4r['post']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_1jq8r4r['post']['resBody'], BasicHeaders, Methods_1jq8r4r['post']['status']>(prefix, PATH29, POST, option).json().then(r => r.body),
        ...
        categories: {
          all: {
             ...
             */
            get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_4nql1b['get']['resBody'], BasicHeaders, Methods_4nql1b['get']['status']>(prefix, PATH35, GET, option).json(),
            /**
             * @returns OK
             */
            $get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_4nql1b['get']['resBody'], BasicHeaders, Methods_4nql1b['get']['status']>(prefix, PATH35, GET, option).json().then(r => r.body),
            $path: () => `${prefix}${PATH35}`,
          },
          /**
           * @returns OK
          ...
          get: (option?: { query?: Methods_3uzp0j['get']['query'] | undefined, config?: T | undefined } | undefined) =>
            fetch<Methods_3uzp0j['get']['resBody'], BasicHeaders, Methods_3uzp0j['get']['status']>(prefix, PATH34, GET, option).json(),
          /**
           * @returns OK
           */
          $get: (option?: { query?: Methods_3uzp0j['get']['query'] | undefined, config?: T | undefined } | undefined) =>
            fetch<Methods_3uzp0j['get']['resBody'], BasicHeaders, Methods_3uzp0j['get']['status']>(prefix, PATH34, GET, option).json().then(r => r.body),
          /**
           * @returns OK
           */
          post: (option: { body: Methods_3uzp0j['post']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_3uzp0j['post']['resBody'], BasicHeaders, Methods_3uzp0j['post']['status']>(prefix, PATH34, POST, option).json(),
          /**
           * @returns OK
           */
          $post: (option: { body: Methods_3uzp0j['post']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_3uzp0j['post']['resBody'], BasicHeaders, Methods_3uzp0j['post']['status']>(prefix, PATH34, POST, option).json().then(r => r.body),
          /**
           * @returns OK
           */
          put: (option: { body: Methods_3uzp0j['put']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_3uzp0j['put']['resBody'], BasicHeaders, Methods_3uzp0j['put']['status']>(prefix, PATH34, PUT, option).json(),
          /**
           * @returns OK
           */
          $put: (option: { body: Methods_3uzp0j['put']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_3uzp0j['put']['resBody'], BasicHeaders, Methods_3uzp0j['put']['status']>(prefix, PATH34, PUT, option).json().then(r => r.body),
        ...
        favoriteBooks: {
          ...
          toggle: {
            ...
            post: (option: { body: Methods_fan7fs['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods_fan7fs['post']['resBody'], BasicHeaders, Methods_fan7fs['post']['status']>(prefix, PATH37, POST, option).json(),
            /**
             * @returns OK
             */
            $post: (option: { body: Methods_fan7fs['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods_fan7fs['post']['resBody'], BasicHeaders, Methods_fan7fs['post']['status']>(prefix, PATH37, POST, option).json().then(r => r.body),
            $path: () => `${prefix}${PATH37}`,
          },
        },
        features: {
          ...
          all: {
             ...
             */
            get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_1alr8do['get']['resBody'], BasicHeaders, Methods_1alr8do['get']['status']>(prefix, PATH39, GET, option).json(),
            /**
             * @returns OK
             */
            $get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_1alr8do['get']['resBody'], BasicHeaders, Methods_1alr8do['get']['status']>(prefix, PATH39, GET, option).json().then(r => r.body),
            $path: () => `${prefix}${PATH39}`,
          },
          /**
           * @returns OK
          ...
          get: (option?: { query?: Methods_bxzk2o['get']['query'] | undefined, config?: T | undefined } | undefined) =>
            fetch<Methods_bxzk2o['get']['resBody'], BasicHeaders, Methods_bxzk2o['get']['status']>(prefix, PATH38, GET, option).json(),
          /**
           * @returns OK
           */
          $get: (option?: { query?: Methods_bxzk2o['get']['query'] | undefined, config?: T | undefined } | undefined) =>
            fetch<Methods_bxzk2o['get']['resBody'], BasicHeaders, Methods_bxzk2o['get']['status']>(prefix, PATH38, GET, option).json().then(r => r.body),
          /**
           * @returns OK
           */
          post: (option: { body: Methods_bxzk2o['post']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_bxzk2o['post']['resBody'], BasicHeaders, Methods_bxzk2o['post']['status']>(prefix, PATH38, POST, option).json(),
          /**
           * @returns OK
           */
          $post: (option: { body: Methods_bxzk2o['post']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_bxzk2o['post']['resBody'], BasicHeaders, Methods_bxzk2o['post']['status']>(prefix, PATH38, POST, option).json().then(r => r.body),
        ...
        packages: {
          ...
          get: (option?: { query?: Methods_18onvqa['get']['query'] | undefined, config?: T | undefined } | undefined) =>
            fetch<Methods_18onvqa['get']['resBody'], BasicHeaders, Methods_18onvqa['get']['status']>(prefix, PATH40, GET, option).json(),
          /**
           * @returns OK
           */
          $get: (option?: { query?: Methods_18onvqa['get']['query'] | undefined, config?: T | undefined } | undefined) =>
            fetch<Methods_18onvqa['get']['resBody'], BasicHeaders, Methods_18onvqa['get']['status']>(prefix, PATH40, GET, option).json().then(r => r.body),
          /**
           * @returns OK
           */
          post: (option: { body: Methods_18onvqa['post']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_18onvqa['post']['resBody'], BasicHeaders, Methods_18onvqa['post']['status']>(prefix, PATH40, POST, option).json(),
          /**
           * @returns OK
           */
          $post: (option: { body: Methods_18onvqa['post']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_18onvqa['post']['resBody'], BasicHeaders, Methods_18onvqa['post']['status']>(prefix, PATH40, POST, option).json().then(r => r.body),
        ...
        payment: {
          init_webhook: {
            post: (option?: { config?: T | undefined } | undefined) =>
              fetch<void, BasicHeaders, Methods_1tulz1e['post']['status']>(prefix, PATH41, POST, option).send(),
            $post: (option?: { config?: T | undefined } | undefined) =>
              fetch<void, BasicHeaders, Methods_1tulz1e['post']['status']>(prefix, PATH41, POST, option).send().then(r => r.body),
            $path: () => `${prefix}${PATH41}`,
          },
          payment_links: {
            /**
            ...
            post: (option: { body: Methods_za6i4m['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods_za6i4m['post']['resBody'], BasicHeaders, Methods_za6i4m['post']['status']>(prefix, PATH42, POST, option).json(),
            /**
             * @returns OK
             */
            $post: (option: { body: Methods_za6i4m['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods_za6i4m['post']['resBody'], BasicHeaders, Methods_za6i4m['post']['status']>(prefix, PATH42, POST, option).json().then(r => r.body),
            $path: () => `${prefix}${PATH42}`,
          },
          webhook: {
            /**
            ...
            post: (option: { body: Methods_1ol7w11['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods_1ol7w11['post']['resBody'], BasicHeaders, Methods_1ol7w11['post']['status']>(prefix, PATH43, POST, option).json(),
            /**
             * @returns OK
             */
            $post: (option: { body: Methods_1ol7w11['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods_1ol7w11['post']['resBody'], BasicHeaders, Methods_1ol7w11['post']['status']>(prefix, PATH43, POST, option).json().then(r => r.body),
            $path: () => `${prefix}${PATH43}`,
          },
        },
        posts: {
          ...
          filter: {
            ...
            post: (option: { body: Methods_2472sl['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods_2472sl['post']['resBody'], BasicHeaders, Methods_2472sl['post']['status']>(prefix, PATH46, POST, option).json(),
            /**
             * @returns OK
             */
            $post: (option: { body: Methods_2472sl['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods_2472sl['post']['resBody'], BasicHeaders, Methods_2472sl['post']['status']>(prefix, PATH46, POST, option).json().then(r => r.body),
            $path: () => `${prefix}${PATH46}`,
          },
          increase_views: {
            _postId: (val4: string) => {
              const prefix4 = `${PATH47}/${val4}`;
          ...
          like: {
            ...
            post: (option: { body: Methods_1w8n6s8['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods_1w8n6s8['post']['resBody'], BasicHeaders, Methods_1w8n6s8['post']['status']>(prefix, PATH48, POST, option).json(),
            /**
             * @returns OK
             */
            $post: (option: { body: Methods_1w8n6s8['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods_1w8n6s8['post']['resBody'], BasicHeaders, Methods_1w8n6s8['post']['status']>(prefix, PATH48, POST, option).json().then(r => r.body),
            $path: () => `${prefix}${PATH48}`,
          },
          top_liked: {
            _count: (val4: number) => {
              const prefix4 = `${PATH49}/${val4}`;
          ...
          get: (option?: { query?: Methods_xu0xli['get']['query'] | undefined, config?: T | undefined } | undefined) =>
            fetch<Methods_xu0xli['get']['resBody'], BasicHeaders, Methods_xu0xli['get']['status']>(prefix, PATH44, GET, option).json(),
          /**
           * @returns OK
           */
          $get: (option?: { query?: Methods_xu0xli['get']['query'] | undefined, config?: T | undefined } | undefined) =>
            fetch<Methods_xu0xli['get']['resBody'], BasicHeaders, Methods_xu0xli['get']['status']>(prefix, PATH44, GET, option).json().then(r => r.body),
          /**
           * @returns OK
           */
          post: (option: { body: Methods_xu0xli['post']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_xu0xli['post']['resBody'], BasicHeaders, Methods_xu0xli['post']['status']>(prefix, PATH44, POST, option).json(),
          /**
           * @returns OK
           */
          $post: (option: { body: Methods_xu0xli['post']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_xu0xli['post']['resBody'], BasicHeaders, Methods_xu0xli['post']['status']>(prefix, PATH44, POST, option).json().then(r => r.body),
          /**
           * @returns OK
           */
          put: (option: { body: Methods_xu0xli['put']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_xu0xli['put']['resBody'], BasicHeaders, Methods_xu0xli['put']['status']>(prefix, PATH44, PUT, option).json(),
          /**
           * @returns OK
           */
          $put: (option: { body: Methods_xu0xli['put']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_xu0xli['put']['resBody'], BasicHeaders, Methods_xu0xli['put']['status']>(prefix, PATH44, PUT, option).json().then(r => r.body),
        ...
        trading_posts: {
          ...
          _tradingPostId: (val3: string) => {
            ...
            return {
              trading_requests: {
                 ...
                 */
                get: (option?: { config?: T | undefined } | undefined) =>
                  fetch<Methods_142qpja['get']['resBody'], BasicHeaders, Methods_142qpja['get']['status']>(prefix, `${prefix3}${PATH53}`, GET, option).json(),
                /**
                 * @returns OK
                 */
                $get: (option?: { config?: T | undefined } | undefined) =>
                  fetch<Methods_142qpja['get']['resBody'], BasicHeaders, Methods_142qpja['get']['status']>(prefix, `${prefix3}${PATH53}`, GET, option).json().then(r => r.body),
          ...
          top: {
            ...
            get: (option?: { query?: Methods_1rm27j2['get']['query'] | undefined, config?: T | undefined } | undefined) =>
              fetch<Methods_1rm27j2['get']['resBody'], BasicHeaders, Methods_1rm27j2['get']['status']>(prefix, PATH54, GET, option).json(),
            /**
             * @returns OK
             */
            $get: (option?: { query?: Methods_1rm27j2['get']['query'] | undefined, config?: T | undefined } | undefined) =>
              fetch<Methods_1rm27j2['get']['resBody'], BasicHeaders, Methods_1rm27j2['get']['status']>(prefix, PATH54, GET, option).json().then(r => r.body),
          ...
          v2: {
            ...
            get: (option?: { query?: Methods_12pld7f['get']['query'] | undefined, config?: T | undefined } | undefined) =>
              fetch<Methods_12pld7f['get']['resBody'], BasicHeaders, Methods_12pld7f['get']['status']>(prefix, PATH55, GET, option).json(),
            /**
             * @returns OK
             */
            $get: (option?: { query?: Methods_12pld7f['get']['query'] | undefined, config?: T | undefined } | undefined) =>
              fetch<Methods_12pld7f['get']['resBody'], BasicHeaders, Methods_12pld7f['get']['status']>(prefix, PATH55, GET, option).json().then(r => r.body),
            /**
             * @returns OK
             */
            post: (option: { body: Methods_12pld7f['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods_12pld7f['post']['resBody'], BasicHeaders, Methods_12pld7f['post']['status']>(prefix, PATH55, POST, option).json(),
            /**
             * @returns OK
             */
            $post: (option: { body: Methods_12pld7f['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods_12pld7f['post']['resBody'], BasicHeaders, Methods_12pld7f['post']['status']>(prefix, PATH55, POST, option).json().then(r => r.body),
          ...
          get: (option?: { query?: Methods_16ysl8q['get']['query'] | undefined, config?: T | undefined } | undefined) =>
            fetch<Methods_16ysl8q['get']['resBody'], BasicHeaders, Methods_16ysl8q['get']['status']>(prefix, PATH52, GET, option).json(),
          /**
           * @returns OK
           */
          $get: (option?: { query?: Methods_16ysl8q['get']['query'] | undefined, config?: T | undefined } | undefined) =>
            fetch<Methods_16ysl8q['get']['resBody'], BasicHeaders, Methods_16ysl8q['get']['status']>(prefix, PATH52, GET, option).json().then(r => r.body),
          /**
           * @returns OK
           */
          post: (option: { body: Methods_16ysl8q['post']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_16ysl8q['post']['resBody'], BasicHeaders, Methods_16ysl8q['post']['status']>(prefix, PATH52, POST, option).json(),
          /**
           * @returns OK
           */
          $post: (option: { body: Methods_16ysl8q['post']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_16ysl8q['post']['resBody'], BasicHeaders, Methods_16ysl8q['post']['status']>(prefix, PATH52, POST, option).json().then(r => r.body),
        ...
        trading_requests: {
          ...
          post: (option: { body: Methods_13ddqp1['post']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_13ddqp1['post']['resBody'], BasicHeaders, Methods_13ddqp1['post']['status']>(prefix, PATH56, POST, option).json(),
          /**
           * @returns OK
           */
          $post: (option: { body: Methods_13ddqp1['post']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_13ddqp1['post']['resBody'], BasicHeaders, Methods_13ddqp1['post']['status']>(prefix, PATH56, POST, option).json().then(r => r.body),
          $path: () => `${prefix}${PATH56}`,
        },
        users: {
          _userId: (val3: string) => {
            const prefix3 = `${PATH57}/${val3}`;
          ...
          profile: {
            ...
            put: (option: { body: Methods_1xqu5x7['put']['reqBody'], config?: T | undefined }) =>
              fetch<Methods_1xqu5x7['put']['resBody'], BasicHeaders, Methods_1xqu5x7['put']['status']>(prefix, PATH58, PUT, option).json(),
            /**
             * @returns OK
             */
            $put: (option: { body: Methods_1xqu5x7['put']['reqBody'], config?: T | undefined }) =>
              fetch<Methods_1xqu5x7['put']['resBody'], BasicHeaders, Methods_1xqu5x7['put']['status']>(prefix, PATH58, PUT, option).json().then(r => r.body),
            $path: () => `${prefix}${PATH58}`,
          },
          username: {
            _userName: (val4: string) => {
              const prefix4 = `${PATH59}/${val4}`;
          ...
          get: (option?: { query?: Methods_r5qu0t['get']['query'] | undefined, config?: T | undefined } | undefined) =>
            fetch<Methods_r5qu0t['get']['resBody'], BasicHeaders, Methods_r5qu0t['get']['status']>(prefix, PATH57, GET, option).json(),
          /**
           * @returns OK
           */
          $get: (option?: { query?: Methods_r5qu0t['get']['query'] | undefined, config?: T | undefined } | undefined) =>
            fetch<Methods_r5qu0t['get']['resBody'], BasicHeaders, Methods_r5qu0t['get']['status']>(prefix, PATH57, GET, option).json().then(r => r.body),
