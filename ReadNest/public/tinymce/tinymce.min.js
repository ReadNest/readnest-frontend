!(function () {
  ...
  const $e = (e) => {
    ...
    mt = (e, t, n) => {
      ...
      if (((n = n || e), ct(e))) {
        ...
        for (const o in e)
          if (_e(e, o) && !1 === t.call(n, e[o], o, e)) return !1;
      return !0;
    },
    ft = (e, t) => {
      const n = [];
    ...
    _t = [
      ...
      },
      {
        ...
        search: (e) =>
          (Ke(e, "safari") || Ke(e, "mobile/")) && Ke(e, "applewebkit"),
      },
    ],
    St = [
      {
            ...
            ((e, t) =>
              ue(t.brands, (t) => {
                ...
                return Q(e, (e) => {
                  ...
                  current: e.name,
                  version: Ct.nu(parseInt(t.version, 10), 0),
                }));
              }))(o, e)
          )
          .orThunk(() =>
  ...
  const Kt = () => Wt(),
    ...
    sn = function (e, t, n, o) {
      (o = o || this),
        e &&
          (n && (e = e[n]),
          mt(e, (e, r) => !1 !== t.call(o, e, r, n) && (sn(e, t, n, o), !0)));
    },
    an = {
      trim: rn,
      isArray: ut,
      is: (e, t) =>
        t ? !("array" !== t || !ut(e)) || typeof e === t : void 0 !== e,
      toArray: (e) => {
        if (ut(e)) return e;
        {
          const t = [];
  ...
  const er = (e, t, n) => {
    ...
    Sr = (e) => {
      return (
        ((t = e), Xo.getOption(t))
          .filter((e) => 0 !== e.trim().length || e.indexOf(it) > -1)
          .isSome() ||
        H(_r, xn(e)) ||
      ...
      return ((e, t) => {
        const n = ((e, t) =>
          t.match({
            ...
            relative: (t, n) => ({
              ltr: st(() => gn(e, t, n)),
              rtl: st(() => I.some(gn(e, n, t))),
            }),
            exact: (t, n, o, r) => ({
              ltr: st(() => pn(e, t, n, o, r)),
              rtl: st(() => I.some(pn(e, o, r, t, n))),
            }),
          }))(e, t);
        return ((e, t) => {
          const n = t.ltr();
  ...
  const Cs = (e, t, n, o) =>
    ...
    Ls = (e, t, n) => {
      ...
      q(No(n), (t) => {
        er(t, s, a).each((n) => {
          const o = ((t) =>
            Y(Hn(t), (t) => s(t) && !e.isValidChild(xn(n), xn(t))))(t);
          if (o.length > 0) {
            const t = Mn(n);
            q(o, (t) => {
              er(t, s, a).each((n) => {
                ((e, t, n) => {
                  ...
                  if (r) {
                    ...
                    Ds(e, a, !1),
                      Es(e, s, { checkRootAsContent: !0 }) ||
                        r.insertBefore(s, t),
                      Es(e, n, { checkRootAsContent: !0 }) ||
                        r.insertBefore(n, t),
                      Es(e, a, { checkRootAsContent: !0 }) ||
                        r.insertBefore(a, t),
                      r.removeChild(t);
                  }
                })(e, n.dom, t.dom);
    ...
    ba = {
      html4: st(() => ha("html4")),
      html5: st(() => ha("html5")),
      "html5-strict": st(() => ha("html5-strict")),
    },
    va = (e, t) => {
                        ...
                        q(ma(e, "|"), (e) => {
                          ...
                          if (a) {
                            ...
                            if (
                              ...
                              return (
                                delete r[i], void s.splice(an.inArray(s, i), 1)
                              );
                            if (
                              (l &&
                                ("=" === l
                  ...
                  return [
                    {
                      operation: t,
                      name: n[2],
                      validChildren: te(ma(n[3], "|"), (e) => ya(e).toArray()),
                    },
                  ];
                }
                return [];
            ...
            for (
              ...
              if (t && d) {
                ...
                "font-weight" === t && "700" === d
                  ...
                  "rgb" ==
                    ((E = d),
                    Oa.test(E) ? "rgb" : Ba.test(E) ? "rgba" : "other") &&
                    Da(d).each((e) => {
        ...
        if (t) {
          ...
          for (; s--; ) {
            ...
            if (a) {
              ...
              (n && 0 !== a.length) ||
                (delete r[t],
                $a(e, a.fakeName || t, a.nativeHandler, a.capture));
            }
          }
        } else
          pe(r, (t, n) => {
      ...
      const a = Ys.forElement(mn(e), {
        ...
        k = (e, t, n) => {
          ...
          if (
            !y(o) &&
            (Wr(o) ||
              (qr((r = o)) && "http://www.w3.org/2000/svg" === r.namespaceURI))
          )
            return n
              ? Lo(mn(o), Qa(t))
              : ("float" ===
        ...
        Y = {
          ...
          events: c,
          isBlock: (e) =>
            m(e) ? _e(u, e) : qr(e) && (_e(u, e.nodeName) || js(l, e)),
          root: null,
          ...
          createHTML: (e, t, n = "") => {
            ...
            for (const e in t)
              Se(t, e) && (o += " " + e + '="' + I(t[e]) + '"');
            return tt(n) && _e(l.getVoidElements(), e)
              ? o + " />"
              : o + ">" + n + "</" + e + ">";
          },
          createFragment: (t) => {
    ...
    li = {
      ...
      translate: (e) => {
        ...
        if (((e) => p(e) && e.length > 1)(e)) {
          const t = e.slice(1);
          return s(
            r(e[0]).replace(/\{([0-9]+)\}/g, (e, o) => (_e(t, o) ? n(t[o]) : e))
          );
        }
        return s(r(e));
      },
  ...
  const ci = N("mce-annotation"),
    ...
    vi = (e, t) =>
      vo(e, "data-mce-bogus") ||
      ((e, t, n) => or(e, '[data-mce-bogus="all"]', n).isSome())(e, 0, hi(t)),
    yi = (e, t) => {
    ...
    Ii = es,
    Fi = (e) => (
      Ii(e) && (e = e.parentNode), Mi(e) && e.hasAttribute("data-mce-caret")
    ),
    Ui = (e) => Ii(e) && Di(e.data),
    zi = (e) => Fi(e) || Ui(e),
    ...
    Hi = (e) => {
      ...
      return (
        !!es(t) &&
        (t.data.charAt(e.offset()) === Pi ||
          (e.isAtStart() && Ui(t.previousSibling)))
      );
    },
    $i = (e) => {
      const t = e.container();
      return (
        !!es(t) &&
        (t.data.charAt(e.offset() - 1) === Pi ||
          (e.isAtEnd() && Ui(t.nextSibling)))
      );
    },
    ...
    Qi = (e, t) => {
      ...
      return (
        e.bottom - n < t.top ||
        (!(e.top > t.bottom) && Zi(t.top - e.bottom, e, t))
      );
    },
    Ji = (e, t) =>
      e.top > t.bottom || (!(e.bottom < t.top) && Zi(t.bottom - e.top, e, t)),
    el = (e, t, n) => {
    ...
    ml = zi,
    fl = (e) =>
      !ml(e) && (ll(e) ? !dl(e.parentNode) : cl(e) || il(e) || ul(e) || gl(e)),
    gl = (e) =>
      !((e) => qr(e) && "true" === e.getAttribute("unselectable"))(e) && al(e),
    pl = (e, t) =>
      fl(e) &&
      ((e, t) => {
        ...
        n ||
          (n = ((e) => {
            const t = [],
              ...
              o = (e, t) => {
                ...
                if (t < e.data.length) {
                  ...
                  if (
                    rl(e.data[t - 1]) &&
                    (o.setStart(e, t), o.setEnd(e, t + 1), !Al(o))
                  )
            ...
            if (hl(r))
              if (e.isAtEnd()) {
                const e = Sl(r, s);
                El(e) && o(e, e.data.length),
                  Cl(e) && !xl(e) && n(Bl(Ol(e), !1));
              } else {
                const a = Sl(r, s);
  ...
  (Pl.fromRangeStart = (e) => Pl(e.startContainer, e.startOffset)),
    ...
    (Pl.isAbove = (e, t) =>
      ze(le(t.getClientRects()), de(e.getClientRects()), Qi).getOr(!1)),
    (Pl.isBelow = (e, t) =>
      ze(de(t.getClientRects()), le(e.getClientRects()), Ji).getOr(!1)),
  ...
  const Dl = (e, t) => {
    ...
    Ll = (e, t, n) => {
      ss(n)
        ? ((e, t, n) => {
            ...
            t.insertNode(n),
              o.each((t) => Dl(e, t.previousSibling)),
              r.each((t) => Dl(e, t.nextSibling));
          })(e, t, n)
        : ((e, t, n) => {
    ...
    zl = (e) =>
      e
        ? pt(
            e.childNodes,
            (e, t) => (
              Il(t) && "BR" !== t.nodeName ? (e = e.concat(zl(t))) : e.push(t),
              e
            ),
            []
          )
    ...
    Zl = (e, t, n) => {
      ...
      const s = ((e) =>
        Gl(e.startContainer, e.startOffset) || Gl(e.endContainer, e.endOffset))(
        r
      );
      if (s) {
        const e = s.tagName;
    ...
    um = (e) =>
      ...
      ((e) =>
        !!gl(e) &&
        !G(ce(e.getElementsByTagName("*")), (e, t) => e || sl(t), !1))(e),
    mm = pl,
    fm = (e, t) =>
    ...
    pm = (e, t, n) => {
      ...
      if (t.isEqual(Pl.after(n)) && n.lastChild) {
        if (
          ((a = Pl.after(n.lastChild)),
          $u(e) && cm(n.lastChild) && lm(n.lastChild))
        )
      ...
      if (
        o &&
        ((Hu(e) && a.isAtEnd()) || ($u(e) && a.isAtStart())) &&
        ((o = qu(o, e, M, n, !0)), mm(o, n))
      )
        return gm(e, o);
      r = o ? qu(o, e, mm, n) : o;
      const d = bt(
      ...
      return !d || (r && d.contains(r))
        ? r
          ? gm(e, r)
          : null
        : ((a = Hu(e) ? Pl.after(d) : Pl.before(d)), a);
    },
    ...
    wm = (e, t, n) =>
      Cm(e, t, n).bind((o) =>
        ...
        ((e, t, n) => {
          return e
            ? !ym(t, n) &&
                ((o = t), !(!Pl.isTextPosition(o) && as(o.getNode()))) &&
                vm(t) &&
                bm(n)
            : !ym(n, t) && bm(t) && vm(n);
          var o;
    ...
    Em = (e, t, n, o) =>
      wm(e, t, n).bind((n) => (o(n) ? Em(e, t, n, o) : I.some(n))),
    xm = (e, t) => {
      ...
      ((e, t) => {
        ...
        if (t) {
          if (Bm(t))
            return ((e, t) => {
              const n = e.createRng();
              return Im(e, !0, t, n) && Im(e, !1, t, n)
                ? I.some({ range: n, forward: Pm(t) })
                : I.none();
            })(n, t);
          if (((e) => m(e.start))(t))
            return ((e, t) => {
  ...
  const qm = (e) => "" !== e && -1 !== " \f\n\r\t\v".indexOf(e),
        ...
        ((e) => {
          ...
          return es(t)
            ? n === t.data.length
              ? I.some(mn(t))
              : I.none()
            : I.from(t.childNodes[n - 1]).map(mn);
        })(t),
        (t, n) => {
    ...
    af = (e, t, n) => {
      ...
      of(o, !0, () => {
        ...
        a && cs(s) && r.isChildOf(s, e.getBody())
    ...
    cf = (e, t) =>
      !!e.getTextBlockElements()[t.nodeName.toLowerCase()] || js(e, t),
    ...
    Lf = (e, t, n, o, r, s) => {
        ...
        d = (t, n, o) => {
          ...
          return I.from(
            i(
              t,
              n,
              (e, t) => (Nf(e.parentNode) ? -1 : ((a = e), o(r, e, t))),
              l
            )
          );
        };
      return d(n, o, Pf)
        .bind((e) =>
          s ? d(e.container, e.offset + (r ? -1 : 0), Df) : I.some(e)
        )
        .orThunk(() =>
    ...
    If = (e, t, n, o) => {
      ...
      if (
        (s && wf(i) && i.wrapper && (s = Rf(e, s, "ul,ol").reverse()[0] || s),
        !s)
      )
        for (
          s = n;
          s && s[o] && !e.isBlock(s[o]) && ((s = s[o]), !pf(s, "br"));
    ...
    Ff = (e, t, n, o) => {
      ...
      return (
        !C(n[o]) && (!(r !== t && !y(r) && !e.isBlock(r)) || Ff(e, t, r, o))
      );
    },
    Uf = (e, t, n, o, r, s) => {
      let a = n;
    ...
    jf = (e, t, n, o = {}) => {
      ...
      return (
        ...
        qr(c) &&
          c.hasChildNodes() &&
          ((c = nl(c, t.collapsed ? u : u - 1)), es(c) && (u = c.data.length)),
        (l = Of(e, l)),
        (c = Of(e, c)),
        zf(l) &&
        ...
        (xf(m) || m.block_expand) &&
          ...
          (xf(m) && es(c) && u !== c.data.length) ||
            (c = Uf(e, n, c, u, !1, s))),
        _f(m) &&
          ((l = Mf(e, n, t, l, "previousSibling")),
          (c = Mf(e, n, t, c, "nextSibling"))),
        (wf(m) || Ef(m)) &&
          ...
          wf(m) &&
            ...
            e.isBlock(c) ||
              ((c = Uf(e, n, c, u, !1, s)), es(c) && (u = c.data.length)))),
  ...
  const Xf = (e, t, n) =>
    ...
    Zf = (e) =>
      Tr.range(
        e.start,
        Gf(e.soffset, e.start),
        e.finish,
        Gf(e.foffset, e.finish)
      ),
    ...
    og = (e) =>
      (e.bookmark ? e.bookmark : I.none())
        .bind((t) => {
          return (
            (n = mn(e.getBody())), (o = t), I.from(o).filter(Jf(n)).map(Zf)
          );
          var n, o;
        })
        .bind(tg),
  ...
  const cg = ni.DOM,
    ...
    mg = (e, t) => {
      const n = hc(e),
        o = cg.getParent(
          t,
          (t) =>
            ((e) => qr(e) && rg.isEditorUIElement(e))(t) ||
            (!!n && e.dom.is(t, n))
        );
      return null !== o;
    },
    ...
    pg = (e, t) => {
      e.focusedEditor === t.editor && (e.focusedEditor = null),
        !e.activeEditor &&
          dg &&
          (cg.unbind(document, "focusin", dg), (dg = null));
    },
    hg = (e, t) => {
      ((e, t) =>
        ((e) =>
          e.collapsed
            ? I.from(nl(e.startContainer, e.startOffset)).map(mn)
            : I.none())(t).bind((t) =>
      ...
      e.inline
        ? ((e) => {
            ...
            return (
              ...
              ro(n) ||
                ((o = n),
                so(Yn(o)).filter((e) => o.dom.contains(e.dom))).isSome())
            );
            var n, o;
          })(e)
    ...
    wg = {
      ...
      HOME: 36,
      modifierPressed: (e) =>
        e.shiftKey || e.ctrlKey || e.altKey || wg.metaKeyPressed(e),
      metaKeyPressed: (e) =>
        nn.os.isMacOS() || nn.os.isiOS() ? e.metaKey : e.ctrlKey && !e.altKey,
    },
    ...
    Dg = (e, t, n, o) => {
      ...
      if (
        (qr(i) && l > i.childNodes.length - 1 && (u = !1),
        rs(i) && ((i = r), (l = 0)),
        i === r)
      ) {
    ...
    Ig = (e) => {
      ...
      if (t === o && es(t)) {
        ...
        (es(t) && n > 0 && n < t.data.length && ((t = Mg(t, n)), (n = 0)),
        es(o) && r > 0 && r < o.data.length)
      ) {
        const e = Mg(o, r).previousSibling;
        (o = e), (r = e.data.length);
      }
  ...
  (Fg.compareRanges = Rg),
    (Fg.getCaretRangeFromPoint = Ng),
    (Fg.getSelectedNode = tl),
    (Fg.getNode = nl);
  const Ug = (e) => "textarea" === xn(e),
    ...
    Xg = (e, t, n, o, r) => {
      ...
      a.top < i.y
        ? Ko(o.element, !1 !== r)
        : a.top > i.bottom && Ko(o.element, !0 === r);
    },
  ...
  const Pp = ["font", "text-decoration", "text-emphasis"],
    ...
    Up = (e) => {
      ...
      return (
        es(t) &&
        (0 === t.data.length || (Di(t.data) && Yf.isBookmarkNode(t.parentNode)))
      );
    },
    zp = (e, t) => (n) =>
      Yu(e ? 0 : -1, n)
    ...
    Hp = (e) =>
      cs(e) && !((e) => qr(e) && "all" === e.getAttribute("data-mce-bogus"))(e),
    $p = zp(!0, jp),
    Vp = zp(!1, jp),
    qp = zp(!0, gs),
    Wp = zp(!1, gs),
    ...
    Zp = (e, t) =>
      ((e, t, n) =>
        wn(t, e) ? In(e, (e) => n(e) || Cn(e, t)).slice(0, -1) : [])(e, t, L),
    ...
    ch = (e, t, n) =>
      ((e) => I.from(e.getNode(!0)).map(mn))(t).exists(_i) ||
      lh(!1, e, t, n).isSome(),
    uh = T(lh, !1),
    mh = T(lh, !0),
    ...
    ph = (e, t, n) =>
      fh(t) ? Fp(t) : Fp(t) || Sm(gh(e, t, n).dom, t).exists(Fp),
    hh = (e, t, n) =>
      fh(t) ? Ip(t) : Ip(t) || _m(gh(e, t, n).dom, t).exists(Ip),
    bh = (e) =>
      om(e)
        .bind((e) => tr(e, Nn))
        .exists((e) =>
    ...
    kh = (e, t, n, o) => {
      ...
      return n || !xh(r, r.length - 1) || Eh(e, s, o)
        ? !!(n && _h(r, r.length - 1) && wh(e, s, o)) &&
            ((t.data = r.slice(0, -1) + it), !0)
    ...
    Ph = (e) => {
      return fl(e.previousSibling)
        ? I.some(
            ((t = e.previousSibling),
            es(t) ? Pl(t, t.data.length) : Pl.after(t))
          )
        : e.previousSibling
        ...
        e
          ? ((e, t) =>
              Dh(t)
                ...
                .orThunk(() =>
                  ((e, t) =>
                    _m(e, Pl.after(t)).orThunk(() => Sm(e, Pl.before(t))))(e, t)
                ))(t, n)
          : ((e, t) =>
              Ph(t)
                .orThunk(() => Dh(t))
      ...
      const l = ((e, t, n, o) => {
        ...
        return (
          ...
          a.isSome() && i.isSome() && l.isSome()
            ...
            () => (
              o &&
                (r.each((e) => Th(e.dom, e.dom.length, n)),
                s.each((e) => Ah(e.dom, 0, n))),
              t
            )
          )
        );
        ...
        s,
        e.schema,
        ((e, t) => _e(e.schema.getTextInlineElements(), xn(t)))(e, n)
      );
    ...
    Hh = (e, t, n) => {
      const o = ((e, t, n) => Y(ni.DOM.getParents(n.container(), "*", t), e))(
        e,
        t,
        n
      );
    ...
    Jh = (e) => {
      var t;
      return (8 === _n((t = e)) || "#comment" === xn(t) ? Fn(e) : qn(e))
        .bind(Jh)
        .orThunk(() => I.some(e));
    },
    eb = (e, t, n, o = !0) => {
      ...
      if (
        (a.dom === e.getBody()
          ? Zh(e, o)
          : xs(e.schema, a, { checkRootAsContent: !1 }) &&
            (Bi(a), o && e.selection.setCursorLocation(a.dom, 0)),
        !Cn(n, a))
      ) {
        const t = Fe(Ln(a), n)
          ? []
    ...
    ib = (e, t) =>
      Gm(e.start, t).bind((n) => Gm(e.end, t).bind((e) => je(Cn(n, e), n))),
    lb = (e) => (t) =>
      ib(t, e).map((e) =>
        ((e, t, n) => ({ rng: e, table: t, cells: n }))(t, e, tb(e))
      ),
    db = (e, t, n, o) => {
    ...
    cb = (e, t) => J(e, (e) => Cn(e, t)),
    ub = (e) =>
      ze(cb(e.cells, e.rng.start), cb(e.cells, e.rng.end), (t, n) =>
        e.cells.slice(t, n + 1)
      ),
    mb = (e, t) => {
            ...
            db(e, t, n, o)
              ...
              .bind((e) => {
                ...
                if (o && e.cells.length === r.length)
                  return I.some(rb.fullTable(e.table));
                if (r.length > 0) {
        ...
        const o = e.selection.getRng(),
          r = n
            .bind(({ rng: n, isStartInTable: r }) => {
              const s = ((e, t) =>
                I.from(e.dom.getParent(t, e.dom.isBlock)).map(mn))(
                e,
              ...
              n.deleteContents(),
                ((e, t, n) => {
                  n.each((n) => {
                    t
                      ? Eo(n)
                      : (Bi(n), e.selection.setCursorLocation(n.dom, 0));
                  });
          ...
          ((e, t, n, o) => {
              ...
              xs(e.schema, o, { checkRootAsContent: !1 })
                ...
                : ((e, t, n, o, r) =>
                    wm(n, e.getBody(), r).bind((e) =>
                      wb(t, mn(e.getNode())).bind((e) =>
                        Cn(e, o) ? I.none() : I.some(_)
                      )
                    ))(e, n, t, o, r)
            );
          })(e, t, o, n).orThunk(() =>
            je(
              ((e, t) => {
                ...
                return (
                  _b(t, n) || Cm(t, e.getBody(), n).exists((e) => _b(t, e))
                );
              })(e, t),
              _
            )
              ...
              : ((e, t, n, o) =>
                  Eb(t, o).fold(
                    () =>
                      ((e, t, n) =>
                        fb(t, n).bind((t) =>
                          t.fold(T(yb, e), T(Cb, e), T(bb, e), T(vb, e))
                        ))(e, t, n),
                    (t) => ((e, t) => xb(e, t))(e, t)
                  ))(e, o, r, t);
          })(e, n, o);
    ...
    Kb = (e, t, n, o) => {
      ...
      return s
        ? c(1)
          ...
          : c(2)
          ? ((e, t, n, o) => (o.insertAfter(t.reverse(), e), Wb(t[0], n)))(
              s,
              a,
              d,
              t
      ...
      m === f &&
        ...
        s.isCollapsed() ||
          ((e) => {
            ...
            ((e, t, n) =>
              !!C(n) && n === e.getParent(t.endContainer, Xb) && Jm(mn(n), t))(
              t,
              n,
              o
            )
              ...
              if (
                ...
                const n = Dp(o, e),
                  ...
                  d = (t) =>
                    ...
                    o.is(t, s) &&
                    a(t) &&
                    ((t.nodeName === e.nodeName && l(n, Dp(o, t))) ||
                      d(t.children[0])),
                  c = (n) =>
    ...
    rv = (e, t, n, o, r) => {
      ...
      const a = e.dom.getParent(
        t,
        (t) => !!ov(e, t, n) || t.parentNode === s || !!iv(e, t, n, o, !0)
      );
      return !!iv(e, a, n, o, r);
    },
    sv = (e, t, n) =>
      ...
      if (a)
        if (ct(a)) {
          for (let n = 0; n < a.length; n++)
            if (i ? e.getAttrib(t, a[n]) : bf(e, t, a[n])) return !0;
        } else
          for (const o in a)
            if (_e(a, o)) {
    ...
    iv = (e, t, n, o, r) => {
      ...
      if (s && qr(t))
        for (let n = 0; n < s.length; n++) {
          ...
          if (
            sv(e.dom, t, i) &&
            av(a, t, i, "attributes", r, o) &&
            av(a, t, i, "styles", r, o)
          ) {
            const n = i.classes;
            if (n)
              for (let r = 0; r < n.length; r++)
                if (!e.dom.hasClass(t, gf(n[r], o))) return;
            return i;
          }
        }
    },
  ...
  const _v = ["fontWeight", "fontStyle", "color", "fontSize", "fontFamily"],
      ...
      return p(n)
        ? Q(
            ...
            (e) =>
              xf(e) &&
              "span" === e.inline &&
              ((e) => f(e.styles) && $(fe(e.styles), (e) => H(_v, e)))(e)
          )
        : I.none();
    },
    ...
    Nv = (e, t) =>
      !1 ===
      _m(t, Pl.fromRangeEnd(e)).exists(
        (e) => !as(e.getNode()) || _m(t, e).isSome()
      ),
    ...
    Kv = (e, t, n) => {
      ...
      wf(n) &&
        ...
        (((e) => Ef(e) && xf(e) && Fe(xe(e, "mixed"), !0))(n) &&
          !jv(n.inline, t)) ||
          s.remove(t, !0);
    },
    Yv = (e, t, n) =>
      E(e) ? { name: t, value: null } : { name: e, value: gf(t, n) },
    Xv = (e, t) => {
      "" === e.getAttrib(t, "style") &&
    ...
    Gv = (e, t, n, o, r) => {
      ...
      zv(n.styles, (a, i) => {
        const { name: l, value: d } = Yv(i, a, o),
          c = hf(d, l);
        (n.remove_similar || h(d) || !qr(r) || jv(bf(e, r, l), c)) &&
          e.setStyle(t, l, ""),
          (s = !0);
      }),
        s && Xv(e, t);
    ...
    Zv = (e, t, n, o, r) => {
      ...
      if (
        ...
        return Kv(e, o, t), Fv.removed();
      if (!t.ceFalseOverride && o && "false" === s.getContentEditableParent(o))
        return Fv.keep();
      if (o && !sv(s, o, t) && !((e, t) => t.links && "A" === e.nodeName)(o, t))
        return Fv.keep();
      const l = o,
          ...
          const s = e.formatter.get(t),
              ...
              return ((e, t, n, o, r, s, a, i) => {
                ...
                if (n) {
                  ...
                  for (let n = o.parentNode; n && n !== s; n = n.parentNode) {
                    ...
                    for (
                      let n = 0;
                      n < t.length && ((o = Qv(e, t[n], i, o)), null !== o);
                      n++
                    );
            ...
            u = (t) => {
              const n = ce(t.childNodes),
                o = c(t) || $(s, (e) => sv(i, t, e)),
                r = t.parentNode;
              if ((!o && C(r) && _f(a) && c(r), a.deep && n.length))
            ...
            m = (e) => {
              ...
              if (t) {
                ...
                return (
                  ((e) =>
                    Hm(e) && qr(e) && ("_start" === e.id || "_end" === e.id))(
                    n
    ...
    ey = (e, t, n, o, r) =>
      Zv(e, t, n, o, r).fold(L, (t) => (e.dom.rename(o, t), !0), M),
    ty = an.each,
    ny = an.each,
    oy = (e, t, n, o) => {
      if (
    ...
    ry = (e, t, n, o) => {
      const r = e.formatter.get(t),
        ...
        f = (o, a, i) => {
          ...
          Hf(o, a, (a) => {
            ...
            const p = (a) => {
              ...
              if (
                ((o) =>
                  ((e) => wf(e) && !0 === e.wrapper)(s) && iv(e, o, t, n))(a)
              )
                u = null;
              else {
                if (
              ...
              (!(l.length > 1) && o.isBlock(a)) || 0 !== i
                ? (xf(s) || (wf(s) && s.wrapper)) &&
                  (s.exact ||
                    1 !== i ||
                    (a = ((e) => {
                      const t = Q(e.childNodes, sf).filter(
                        (e) =>
                          "false" !== o.getContentEditable(e) && sv(o, e, s)
                      );
                      return t
                        .map((t) => {
                          const n = o.clone(t, !1);
        ...
        g = rf(o) ? o : l.getNode();
      if ("false" === i.getContentEditable(g) && !ff(e, g))
        return c(r, (o = g)), void dd(e, t, o, n);
      if (s) {
        if (o)
          if (rf(o)) {
            if (!c(r, o)) {
  ...
  var _C = (function e() {
    let t =
      arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : xC();
    const n = (t) => e(t);
    if (
      ((n.version = "3.2.4"),
      (n.removed = []),
    ...
    const Re = o.createElement("form"),
      ...
      Te = function () {
        ...
        if (!Ne || Ne !== e) {
          if (
            ...
            (ye = Wy(e, "ALLOWED_NAMESPACES")
              ? Zy({}, e.ALLOWED_NAMESPACES, jy)
              : Ce),
            (me = Wy(e, "ADD_URI_SAFE_ATTR")
              ? Zy(Jy(fe), e.ADD_URI_SAFE_ATTR, ke)
              : fe),
            (ce = Wy(e, "ADD_DATA_URI_TAGS")
              ? Zy(Jy(ue), e.ADD_DATA_URI_TAGS, ke)
              : ue),
            (le = Wy(e, "FORBID_CONTENTS")
              ? Zy({}, e.FORBID_CONTENTS, ke)
              : de),
            ...
            e.FORBID_CONTENTS &&
              (le === de && (le = Jy(le)), Zy(le, e.FORBID_CONTENTS, ke)),
            se && (F["#text"] = !0),
      ...
      Le = function (e) {
        ...
        return (
          e &&
            n &&
            s.insertBefore(o.createTextNode(n), s.childNodes[0] || null),
          be === he
            ? k.call(t, Z ? "html" : "body")[0]
            : Z
            ? t.documentElement
            : s
        );
    ...
    const ze = function (e) {
        ...
        return e instanceof d &&
          ...
          : ("noscript" !== o && "noembed" !== o && "noframes" !== o) ||
            !Ky(/<\/no(script|embed|frames)/i, e.innerHTML)
          ? (X &&
              3 === e.nodeType &&
              ((t = e.textContent),
              Ly([A, T, O], (e) => {
              ...
              e.textContent !== t &&
                (Fy(n.removed, { element: e.cloneNode() }),
                (e.textContent = t))),
      ...
      $e = function (e) {
        ...
        for (; r--; ) {
          ...
          if (je(m, d, c)) {
            ...
            if (c !== u)
              try {
                i ? e.setAttributeNS(i, a, c) : e.setAttribute(a, c),
                  Ie(e) ? Pe(e) : Iy(n.removed);
              } catch (e) {}
          } else De(a, e);
        }
    ...
    return (
      (n.sanitize = function (e) {
        let t =
          ...
          d = null;
        if (
          ((ve = !e), ve && (e = "\x3c!--\x3e"), "string" != typeof e && !Fe(e))
        ) {
        ...
        if (
          (Q || Te(t), (n.removed = []), "string" == typeof e && (ae = !1), ae)
        ) {
          if (e.nodeName) {
        ...
        const c = Me(ae ? e : o);
        for (; (i = c.nextNode()); )
          ze(i), $e(i), i.content instanceof a && Ve(i.content);
        if (ae) return e;
        if (ee) {
          if (te)
          ...
          return (
            (z.shadowroot || z.shadowrootmode) && (d = N.call(r, d, !0)), d
          );
        }
  ...
  const LC = (e, t, n, o, r) => {
    ...
    MC = (e, t, n, o, r, s) =>
      ("html" !== n && !ks(o)) ||
      (!(r in BC && TC(e, s, o)) &&
        (!e.validate || t.isValid(o, r) || Ye(r, "data-") || Ye(r, "aria-"))),
    IC = (e, t) =>
      ...
      n.addHook("uponSanitizeElement", (e, n) => {
        ...
        ((e, n) =>
          r && "semantics" === n
            ...
            : p(t.extended_mathml_elements) &&
              t.extended_mathml_elements.includes(n)
            ? I.from(!0)
            : I.none())(e, a).each((o) => {
      ...
      const n = my(),
        ...
        p = {
          ...
          parse: (e, n = {}) => {
            ...
            Ms(t, c);
            const m = new up(d, 11);
            qC(m, c, t.getSpecialElements(), a.sanitizeNamespaceElement),
              (c.innerHTML = "");
            const [f, p] = ((e, t, n, o) => {
                const r = n.validate,
                  s = t.getNonEmptyElements(),
                  a = t.getWhitespaceElements(),
                  i = VC(
                    $C("script,style,head,html,body,title,meta,param"),
                    t.getBlockElements()
                  ),
                  l = ka(t),
                  d = /[ \t\r\n]+/g,
                  ...
                  f = (n) =>
                    n.name in i || $s(t, n) || (ks(n.name) && n.parent === e),
                  g = (t, n) => {
    ...
    KC = (e, t, n) => {
      ...
      if (ev(e)) {
        if (r.content !== o) {
          const t = WC({ validate: !1, forced_root_block: !1, ...n }).parse(
            r.content,
            { context: e.name }
          );
          return { ...r, content: t };
    ...
    XC = (e, t) => {
      if (t.no_events) return Te.value(t);
      {
        ...
        return n.isDefaultPrevented()
          ? Te.error(md(e, { content: "", ...n }).content)
          : Te.value(n);
      }
    },
    GC = (e, t, n) => {
    ...
    sw = (e, t) => {
      ...
      for (let e = 0; e < n.length; e++) {
        const o = n[e].cells;
        for (let n = 0; n < o.length; n++)
          if (Cn(o[n], t)) return I.some(tw(n, e));
      }
      return I.none();
    },
    aw = (e, t, n, o, r) => {
    ...
    vw = (e, t, n) => {
      ...
      "fragmented" === t.type
        ...
        : e.setContent(t.content, {
            format: "raw",
            no_selection: !C(o) || !Bm(o) || !o.isFakeCaret,
          }),
    ...
    Sw = (e) => ({
      ...
      undoManager: {
        ...
        hasUndo: (t, n) =>
          ((e, t, n) =>
            n.get() > 0 || (t.typing && t.data[0] && !ww(bw(e), t.data[0])))(
            e,
            t,
            n
          ),
        ...
        transact: (e, t, n) =>
          ((e, t, n) => (_w(e, t), e.beforeChange(), e.ignore(n), e.add()))(
            e,
            t,
            n
          ),
      ...
      formatter: {
            ...
            return I.from(e.selection.getStart(!0))
              .bind((o) =>
                xr(
                  ...
                  (n) =>
                    ue(t, (t) =>
                      ((t, n) => (iv(e, t.dom, n) ? I.some(n) : I.none()))(n, t)
                    ),
                  n
                )
              )
        ...
        toggle: (t, n, o) =>
          ((e, t, n, o) => {
            const r = e.formatter.get(t);
            r &&
              (!lv(e, t, n, o) || ("toggle" in r[0] && !r[0].toggle)
                ? sy(e, t, n, o)
                : Jv(e, t, n, o));
          })(e, t, n, o),
        ...
        getContent: (t) =>
          ((e, t) =>
            I.from(e.getBody()).fold(
              N("tree" === t.format ? new up("body", 11) : ""),
              (n) => Np(e, t, n)
            ))(e, t),
        setContent: (t, n) =>
          ((e, t, n) =>
            I.from(e.getBody())
              ...
              .getOr({ content: t, html: ev(n.content) ? "" : n.content }))(
            e,
            t,
            n
          ),
                  ...
                  return ((e) =>
                    I.from(e.selection.getRng())
                      .map((t) => {
                        ...
                        if (
                          (e.dom.remove(i), mw(d, 0) || mw(d, d.length - 1))
                        ) {
                          const e = o.getOr(r),
                            t = fw(e),
                            n = t.indexOf(l);
                      ...
                      .getOr(""))(e);
                {
                  const n = ((e, t) => {
                    const n = e.selection.getRng(),
                      ...
                      s = ap(e, Km(r)),
                      a = t.contextual
                        ? uw(mn(e.getBody()), s, e.schema).dom
                        : n.cloneContents();
                    return (
                      a && o.appendChild(a),
        ...
        (e) => (
          ...
          t.filter(Rn).map((t) =>
            ((e, t, n, o, r) => {
              ...
              o
                ? (Oh(s, a, r, !1, !o), n.setStart(a, i))
                : (Oh(a, s, r, !1, !o), n.setEnd(a, i));
            })(e, t, n, o, r)
          )
        )
      ).orThunk(() => {
        const e = ((e, t) =>
          e.filter((e) => Yf.isBookmarkNode(e.dom)).bind(t ? Un : Fn))(t, o)
          .or(t)
          .filter(Rn);
        return e.map((e) =>
          ((e, t, n) => {
            Ln(e).each((o) => {
              ...
              t && Ch(o, Pl(r, 0), n)
                ? Ah(r, 0, n)
                : !t && wh(o, Pl(r, r.length), n) && Th(r, r.length, n);
            });
          })(e, o, r)
        );
      });
  ...
  const Pw = (e) => !(!e || !e.ownerDocument) && wn(mn(e.ownerDocument), mn(e)),
    Dw = (e, t, n, o) => {
      ...
      const { selectorChangedWithUnbind: a } = ((e, t) => {
        ...
        c = () => {
          ...
          if (
            (n || (n = i.createRange()), rs(n.startContainer) && n.collapsed)
          ) {
            const t = e.getRoot();
        ...
        u = (e, t) => {
          if (!((e) => !!e && Pw(e.startContainer) && Pw(e.endContainer))(e))
            return;
          const n = d();
          if (
        ...
        f = {
          ...
          setCursorLocation: (t, n) => {
            ...
            C(t) && C(n)
              ...
              : (ef(e, r, o.getBody(), !0), u(r));
          },
          getContent: (e) =>
            ((e, t = {}) =>
              ((e, t, n) => Rw(e).selection.getContent(t, n))(
                e,
          ...
          getBoundingClientRect: () => {
            const e = c();
            return e.collapsed
              ? Pl.fromRangeStart(e).getClientRects()[0]
    ...
    Fw = (e, t, n = {}) => {
      ...
      return ZC(e, o)
        .map((t) => {
          const n = ((e, t, n) => Nw(e).editor.setContent(t, n))(
            e,
            t.content,
            t
          );
    ...
    vE = (e) => {
      ...
      hE(t, "mce-content-readonly", !1),
        ...
        ((e, t) => {
          pE(e, "StyleWithCSS", t),
            pE(e, "enableInlineTableEditing", t),
            pE(e, "enableObjectResizing", t);
        })(e, !1),
        yg(e) && e.focus(),
        ((e) => {
    ...
    EE = (e) => {
      e.parser.addAttributeFilter("contenteditable", (t) => {
        yE(e) &&
          q(t, (e) => {
            e.attr(CE, e.attr("contenteditable")),
                    ...
                    return C(s)
                      ...
                      : ((o = t),
                        Ye(o, "blob:")
                          ...
                          hy(t).then((o) =>
                            vy(o, !1, (n) => I.some(yy(e, t, n))).getOrThunk(n)
                          )
                        );
                  }
                  var o, r;
  ...
  const AE = (e, t) => {
    ...
    BE = (e) => {
      ...
      const r = NE(),
        ...
        l = (e, t, n) => {
          const o = `src="${n}"${
            n === nn.transparentSrc ? ' data-mce-placeholder="1"' : ""
          }`;
          return (
            (e = i(e, `src="${t}"`, o)),
                  ...
                  const a = V(n, (n, a) => {
                    ...
                    return (
                      n.status && Fd(e)
                        ...
                        : n.error &&
                          (n.error.remove &&
                            (d(l.src, nn.transparentSrc), r.push(l), (c = !0)),
                          ((e, t) => {
                            uE(
                              e,
                              li.translate(["Failed to upload image: {0}", t])
                            );
                          })(e, n.error.message)),
                      {
                        element: l,
                            ...
                            Eo(n),
                              o.each(
                                ((e) => (t) => {
                                  ((e, t) =>
                                    e.dom.isEmpty(t.dom) &&
                                    C(e.schema.getTextBlockElements()[xn(t)]))(
                                    e,
                                    t
    ...
    zE = (e, t) => {
      const n = (t && t.schema) || Ra({}),
        o = (e) => {
          ...
          return (
            ((e, t) => {
              t.classes.length > 0 && FE.addClass(e, t.classes.join(" ")),
                FE.setAttribs(e, t.attrs);
            })(n, t),
            n
          );
        },
    ...
    HE = (e, t) => {
      ...
      var d;
      l.length > 0
        ? (l[0].name || (l[0].name = i), (i = t.selector), (a = zE(l, e)))
        : (a = zE([i], e));
    ...
    $E = (e) => {
      ...
      return (
        ...
        ((e) => {
          e.on("mouseup keydown", (t) => {
            ...
            ((e, t, n) => {
              ...
              e,
              t.keyCode,
              ((n = e.selection.getRng().endContainer), es(n) && Xe(n.data, it))
            );
          });
        })(e),
        kw(e) ||
          ...
          })(n, e),
        {
          ...
          match: (t, n, o, r) =>
            ((e, t, n, o, r) => Rw(e).formatter.match(t, n, o, r))(
              e,
              t,
              n,
              o,
          ...
          matchAll: (t, n) =>
            ((e, t, n) => Rw(e).formatter.matchAll(t, n))(e, t, n),
          matchNode: (t, n, o, r) =>
            ((e, t, n, o, r) => Rw(e).formatter.matchNode(t, n, o, r))(
              e,
              t,
              n,
              o,
          ...
          formatChanged: (t, o, r, s) =>
            ((e, t, n, o, r, s) =>
              Rw(e).formatter.formatChanged(t, n, o, r, s))(e, n, t, o, r, s),
          getCssText: T(HE, e),
        }
      );
    },
    ...
    qE = (e) => {
      const t = Ve(),
        ...
        r = {
          ...
          add: (s, a) =>
            ((e, t, n, o, r, s, a) => Rw(e).undoManager.add(t, n, o, r, s, a))(
              e,
              r,
              o,
              n,
          ...
          undo: () =>
            ((e, t, n, o) => Rw(e).undoManager.undo(t, n, o))(e, r, n, o),
          ...
          hasUndo: () =>
            ((e, t, n) => Rw(e).undoManager.hasUndo(t, n))(e, r, o),
          hasRedo: () =>
            ((e, t, n) => Rw(e).undoManager.hasRedo(t, n))(e, r, o),
          transact: (t) =>
            ((e, t, n, o) => Rw(e).undoManager.transact(t, n, o))(e, r, n, t),
          ignore: (t) => {
            ((e, t, n) => {
            ...
            e.on("init", () => {
              ...
              e.on("keydown", (e) => {
                ...
                if (
                  ...
                  return (
                    t.beforeChange(), xw(t, !0, n), t.add({}, e), void o.set(!0)
                  );
                (nn.os.isMacOS() ? e.metaKey : e.ctrlKey && !e.altKey) &&
                  t.beforeChange();
              }),
              e.on("mousedown", (e) => {
                t.typing && r(e);
    ...
    tx = (e, t, n, o, r) => {
      ...
      ((e, t) => 0 === Y(zn(t), (t) => !xs(e, t)).length)(o, r) &&
        xs(o, t) &&
        ao(r, cn("br"));
            ...
            ? ((e, t, n, o) => {
                ...
                return ze(r, s, GE).filter(
                  (e) =>
                    ...
                    ((e) =>
                      !1 === cs(e.from.block.dom) && !1 === cs(e.to.block.dom))(
                      e
                    ) &&
                    ((e) => {
                    ...
                    ((e) =>
                      !(
                        wn(e.to.block, e.from.block) ||
                        wn(e.from.block, e.to.block)
                      ))(e)
                );
              })(e, t, n, o)
    ...
    lx = (e) => {
      ...
      return ((e, t) => {
        ...
        : ((e, t, n) => {
            const o = t.getRng();
            return ze(
              Gh(e, mn(o.startContainer)),
              Gh(e, mn(o.endContainer)),
              (r, s) =>
                Cn(r, s)
                  ? I.none()
                  : I.some(() => {
    ...
    Cx = (e, t, n, o) =>
      Cm(t, e, n).bind((r) => {
        return (
          ...
          ((e, t, n, o, r) => {
            const s = (t) =>
              r.isInline(t.nodeName.toLowerCase()) && !Ku(n, o, e);
            ...
            ? ((e, t, n, o, r) => {
                ...
                return Gh(mn(t), mn(o.getNode()))
                  .map((t) =>
                    xs(e, t) ? yx.remove(t.dom) : yx.moveToElement(s)
                  )
          ...
          () =>
            ((e, t, n, o) => {
              ...
              (n) => () =>
                n.fold(
                  ((e, t) => (n) => (
                    e._selectionOverrides.hideFakeCaret(), Fh(e, t, mn(n)), !0
                  ))(e, t),
                  ((e, t) => (n) => {
      ...
      e
        ? ((e) => {
            ...
            if (Ox(e.previousSibling))
              return (
                Px(e.previousSibling) || e.previousSibling.appendData(Pi),
                e.previousSibling
              );
        ...
        : ((e) => {
            ...
            if (Ox(e.nextSibling))
              return (
                Bx(e.nextSibling) || e.nextSibling.insertData(0, Pi),
                e.nextSibling
              );
    ...
    Ix = T(Lx, !1),
    Fx = (e, t) =>
      es(e.container()) ? Lx(t, e.container()) : Lx(t, e.getNode()),
    Ux = (e, t) => {
      const n = t.get();
    ...
    Kx = (e, t, n) => {
      const o = qh(n);
      return Wx(e, t, o).bind((e) =>
        Sm(e, o).isNone() ? I.some(Hx.start(e)) : I.none()
      );
    },
    Yx = (e, t, n) => {
      const o = Vh(n);
      return Wx(e, t, o).bind((e) =>
        _m(e, o).isNone() ? I.some(Hx.end(e)) : I.none()
      );
    },
    Xx = (e, t, n) => {
      const o = qh(n),
  ...
  const i_ = (e, t) => (-1 === e ? oe(t) : t),
    ...
    d_ = (e, t, n, o) =>
      as(o.getNode(1 === t)) ? a_.Br : !1 === Ku(n, o) ? a_.Block : a_.Wrap,
    c_ = (e, t, n, o) => {
      const r = hm(n);
      let s = o;
      const a = [];
  ...
  const A_ = (e, t, n, o, r, s) => {
          ...
          .orThunk(() =>
            ((e, t, n, o, r) => {
              ...
              return Cm(e, n, s)
                ...
                .fold(
                  () => o.map(e_),
                  (r) => Zx(t, n, r).map(T(n_, e, t, n, s, r)).filter(T(o_, o))
                )
                .filter(Gx);
            })(e, t, n, s, o)
          );
    ...
    Q_ = (e, t, n, o) => {
      ...
      e.undoManager.ignore(() => {
        e.selection.setRng(
          ...
          Kh(e),
          Zx(s, r, Pl.fromRangeStart(e.selection.getRng()))
            .map(t_)
            .bind(Z_(e, t))
            .each(D);
      }),
    ...
    rS = (e, t) => {
      const n = Y(
        ((e) => eS(e, (t) => e.schema.isBlock(xn(t)) || ((e) => Wn(e) > 1)(t)))(
          e
        ),
        tS
      );
    ...
    hS = (e) =>
      Y(
        ...
        (e) =>
          !pS(e) &&
          !((e) => Ln(e).exists(pS))(e) &&
          tr(e, (e) => ds(e.dom) || cs(e.dom)).exists((e) => ds(e.dom))
      ),
    bS = (e, t) => {
      var n, o;
    ...
    CS = (e, t, n) =>
      ue([yS, _x, hx, (e, n) => J_(e, t, n), ax, kb, Tx, uS, dx, lS, Ax], (t) =>
        t(e, n)
    ...
    xS = (e, t) =>
      !!es(t) ||
      (!!qr(t) && !(ES(e.getBlockElements(), t) || Hm(t) || js(e, t) || Ns(t))),
    _S = (e, t) => {
      if (es(t)) {
    ...
    DS = (e, t) =>
      ((e, t) => {
        const n = t ? 1 : -1,
          o = e.selection.getRng();
        return ((e, t, n) => I_(t, e, n, Xp, Gp, BS))(n, e, o).orThunk(
          () => (PS(e, n, o), I.none())
        );
      })(
        e,
    ...
    XS = (e, t, n) =>
      te(Hn(e), (e) => (vn(e, t) ? (n(e) ? [e] : []) : XS(e, t, n))),
    GS = (e, t) => sr(e, "table", t),
    ZS = ke([
      { none: ["current"] },
      { first: ["current"] },
  ...
  const lk = De("mode"),
    ...
    _k = (e, t, n) => {
      ...
      return ((e) => e.breakType === a_.Wrap && 0 === e.positions.length)(o) ||
        (!as(n.getNode()) &&
          ((e) => e.breakType === a_.Br && 1 === e.positions.length)(o))
      ...
      if (t && kk(o, s)) {
        const o = ((e, t, n) =>
          ((e, t) =>
            ...
            .orThunk(() =>
              le(n.getClientRects()).bind((n) => m_(b_(e, Pl.after(t)), n.left))
            )
    ...
    Pk = (e, t, n) =>
      n.fold(
        ...
        (n) =>
          e.mode.isReadOnly() || !Dk(n)
            ? I.none()
            : (e.execCommand("mceTableInsertRowAfter"), Lk(e, t, n))
      ),
    ...
    $k = (e, t, n) => {
      ...
      {
        const o = Ei(jk);
        return I.from(o.backwards(e, t, Hk(e), n)).map((e) =>
          zk(e.container, e.container.data.length)
        );
      }
    },
    Vk = (e, t, n) => {
    ...
    qk = (e, t, n) => {
      ...
      {
        const r = Ei(jk);
        return I.from(r.forwards(e, t, Hk(e), n)).bind((e) =>
          qk(e.container, t - o.length, n)
        );
      }
    },
    Wk = (e, t, n, o, r) => {
    ...
    Xk = (e, t, n, o = !1) => {
      ...
      return Wk(
        ...
        return 0 !== r.lastIndexOf(n)
          ? I.none()
          : I.some({ text: Yk(r, n), range: o, trigger: n });
      });
    },
    Gk = (e) => {
          ...
          e.fold(
            ...
            (e) => {
              ...
              return (
                ...
                (a = I.some),
                s.stype === Jk.Value
                  ? { stype: Jk.Value, svalue: a(s.svalue) }
                  : s
              );
              var s, a;
            }
    ...
    wN = (e, t, n) => {
      return (
        (o = ((e, t, n) =>
          ((e, t) =>
            e.stype === Jk.Error
              ? { stype: Jk.Error, serror: t(e.serror) }
  ...
  PN("onAction", _),
    CN([
      (() => TN("type", "autocompleteitem", uN))(0, "autocompleteitem"),
      zN,
      jN,
      HN,
      LN,
  ...
  const WN = (e) => {
        ...
        a = (a) => {
          ((n) =>
            t
              .get()
              .map((t) =>
                Xk(e.dom, e.selection.getRng(), t.trigger, !0).bind((t) =>
                  Qk(e, s, t, n)
                )
              )
              .getOrThunk(() =>
                ((e, t) => {
                  const n = t(),
                    o = e.selection.getRng();
                  return ((e, t, n) => ue(n.triggers, (n) => Xk(e, t, n)))(
                    e.dom,
                    o,
                    n
                  ).bind((n) => Qk(e, t, n));
      ...
      if ("character" === n) {
        ...
        return (
          !!(
            l &&
            (t ? c : d) &&
            wm(!t, s, n).exists((e) => QN(o, e) && !Ue(i, ZN(o, e)))
          ) ||
          wm(t, s, n).fold(L, (n) => {
            const r = ZN(o, n);
            if (QN(o, n) && !Ue(i, r)) {
        ...
        ? ((e, t) =>
            t.startSummary.exists((t) =>
              ((e, t) =>
                Nm(t).exists(
                  (n) =>
                    (as(n.getNode()) && Sm(t, n).exists((t) => t.isEqual(e))) ||
                    n.isEqual(e)
                ))(e, t)
            ))(s, t) ||
          ((e, t, n) =>
            n.startDetails.exists((n) =>
              _m(e, t).forall((e) => !n.contains(e.container()))
            ))(a, s, t)
        : ((e, t) =>
            t.startSummary.exists((t) =>
              ((e, t) => km(t).exists((t) => t.isEqual(e)))(e, t)
            ))(s, t) ||
          ((e, t) =>
    ...
    uR = (e, t) => {
      ...
      if (/^(LI|DT|DD)$/.test(t.nodeName)) {
        ...
        e &&
          ...
          t.insertBefore(n.doc.createTextNode(it), t.firstChild);
      }
      const r = n.createRng();
      ...
      insert: (e, t) => {
        ...
        const i = e.dom,
          ...
          v = (e) => {
            ...
            if (_R(n, "TABLE") || _R(n, "HR"))
              return ((e) =>
                "BR" === e.nodeName ||
                (e.nextSibling && "BR" === e.nextSibling.nodeName))(n)
                ? !e
                : (a && !e) || (!a && e);
            const r = new Fr(n, S);
            let s;
          ...
          w = () => {
            ...
            return (
              (t =
                /^(H[1-6]|PRE|FIGURE)$/.test(r) && "HGROUP" !== k ? b(c) : b()),
              ((e, t) => {
                const n = Ld(e);
                return (
                  !y(t) &&
                  (m(n) ? H(an.explode(n), t.nodeName.toLowerCase()) : n)
                );
              })(e, s) &&
              SR(i, s) &&
        ...
        if (/^(LI|DT|DD)$/.test(r) && qr(s) && i.isEmpty(S))
          return void ((e, t, n, o, r) => {
            ...
            if (wR(n, o, !0) && wR(n, o, !1))
              ...
              if (
                "LI" === r &&
                ((e) => e.firstChild && "LI" === e.firstChild.nodeName)(t)
              ) {
        ...
        if (p)
          ...
          const t = Pl.fromRangeStart(d),
            ...
            o = mn(S),
            r = ch(o, t, e.schema)
              ? uh(o, t, e.schema).bind((e) => I.from(e.getNode()))
              : I.none();
          ...
          const t = ((e) => {
            ...
            return (
              t.setStart(
                e.startContainer,
                kR(!0, e.startContainer, e.startOffset)
              ),
    ...
    zR = (e, t) => (n, o) => {
      const r =
        ((e) => fR(e).fold(N(""), (e) => e.nodeName.toUpperCase()))(n) ===
        e.toUpperCase();
      return r === t;
    },
    jR = (e) => {
    ...
    YR = (e, t) => (n, o) =>
      G(e, (e, t) => e && t(n, o), !0) ? I.some(t) : I.none(),
    XR = (e, t, n) => {
    ...
    oA = (e, t, n) => {
      n && !e.get()
        ? t.on("NodeChange", tA, !0)
        : !n && e.get() && t.off("NodeChange", tA),
        e.set(n);
    },
      ...
      return je(
        ...
        () => {
          ...
          e.selection.isCollapsed() || e.getDoc().execCommand("Delete"),
            ((e, t, n) => (yh(e, t, n) ? aA(t) : iA(t)))(
              t,
              Pl.fromRangeStart(e.selection.getRng()),
              e.schema
            ).each(lA(e));
        }
      );
            ...
            e.on("beforeinput", (t) => {
              (e.selection.isEditable() &&
                !$(
                  ...
                  (t) =>
                    !((e, t) =>
                      !rA(e.getBody(), t.startContainer) ||
                      !rA(e.getBody(), t.endContainer) ||
                      tp(e.dom, t))(e, t)
                )) ||
                t.preventDefault();
            });
                ...
                o.isDefaultPrevented() ||
                  ((e, t, n) => {
                    ...
                    qS(
                      ...
                      .each((t) => {
                        n.preventDefault(),
                          aR(e, o).isDefaultPrevented() || (t(), sR(e, o));
                      });
                  })(e, t, o);
            }),
              e.on("keyup", (t) => {
  ...
  const gA = "x-tinymce/html",
    ...
    AA = (e, t, n) =>
      !!((e, t) =>
        NA(t) && $(iu(e), (e) => Xe(t.toLowerCase(), `.${e.toLowerCase()}`)))(
        e,
        t
      ) &&
      ((e, t, n) => (
    ...
    BA = (e, t, n, o, r) => {
      ...
      if (!s.cancelled) {
        ...
        r
          ? aR(e, "insertFromPaste", {
              dataTransfer: OA(t),
            }).isDefaultPrevented() || (n(), sR(e, "insertFromPaste"))
          : n();
      }
    },
    PA = (e, t, n, o) => {
      ...
      if (jc(e) && o) {
        ...
        if (s.length > 0)
          return (
            ...
            ((r = s),
            Promise.all(
              V(r, (e) => hy(e).then((t) => ({ file: e, uri: t })))
            )).then((t) => {
    ...
    zA = (e, t, n) => {
      ((e, t, n) => {
        ...
        e.on("keydown", (e) => {
          ((e) =>
            (wg.metaKeyPressed(e) && 86 === e.keyCode) ||
        ...
        ((e, t) => {
          e.addCommand("mceTogglePlainTextPaste", () => {
            ...
            e.addCommand("mceInsertClipboardContent", (t, n) => {
              n.html && PA(e, n.html, n.internal, !1),
                n.text && DA(e, n.text, !1);
            });
        })(e, n),
        ((e) => {
          const t = (t) => (n) => {
            ...
            ((e, t) => {
              zc(e) &&
                ...
                e.on("dragover dragend", (n) => {
                  jc(e) && !t.get() && (n.preventDefault(), WA(e, qA(e, n))),
      ...
      const t = ((e, t, n) => {
        const o = Pl.fromRangeStart(e).getNode(),
          r = ((e, t, n) =>
            tr(
              mn(e),
              (e) => ((e) => ds(e.dom))(e) || n.isBlock(xn(e)),
              eT(t)
            ).getOr(mn(t)).dom)(o, t, n),
          s = nT(o, r, !1),
          a = nT(o, r, !0),
  ...
  const sT = (e, t) => Math.abs(e.left - t),
        ...
        s = (e, s) => {
          ...
          return ue(a, r).map((e) =>
            o && !es(e.node) && a.length > 1
              ? ((e, o, s) =>
                  r(o).filter(
                    (o) => Math.abs(s(e, t, n) - s(o, t, n)) < 2 && es(o.node)
                  ))(e, a[1], s).getOr(e)
              : e
          );
        },
    ...
    cT = (e, t, n) =>
      ((e, t, n) => {
        ...
        return ((e, t, n, o) => {
          const r = (t, s) => {
            ...
            return s
              ...
              .orThunk(() =>
                (Cn(t, e) ? I.none() : Mn(t)).bind((e) => r(e, I.some(t)))
              );
          };
          return r(t, I.none());
        })(o, s, t, n);
        ...
        .map((e) =>
          ((e, t) => ({
            node: e.node,
            position: sT(e, t) < aT(e, t) ? rT.Before : rT.After,
          }))(e, t)
        ),
    uT = (e) => {
      var t, n;
    ...
    fT = (e, t, n, o) => {
      ...
      return v(o)
        ...
        : ((e, t, n, o) => ({ ...t, dataTransfer: o, type: e, ...mT(n) }))(
            e,
            o,
            t,
            r
            ...
            const s = r.currentTarget === t.getDoc().documentElement,
              l = ((e, t) => ({ pageX: t.pageX - e.relX, pageY: t.pageY + 5 }))(
                ...
                ((e, t) => {
                  return (
                    (n = ((e) =>
                      e.inline ? uT(e.getBody()) : { left: 0, top: 0 })(e)),
                    (o = ((e) => {
                      const t = e.getBody();
                      return e.inline
      ...
      const t = Ve(),
        ...
        r = ((e, t) => (n) => {
          if (((e) => 0 === e.button)(n)) {
            ...
            if (
              C(o) &&
              ((e, t, n) => gT(n) && n !== t && e.isEditable(n.parentElement))(
                t.dom,
                t.getBody(),
                o
              )
                ...
                xT(t, "drop", r, e.dataTransfer, n).isDefaultPrevented() ||
                  t.undoManager.transact(() => {
                    ((e, t) => {
                      ...
                      ET(t),
                        n && n !== e.getRoot() && e.isEmpty(n) && Bi(mn(n));
                    })(t.dom, e.element),
                      ((e) => {
      ...
      const l = (e) =>
        ...
        m = (t) => {
          const o = e.schema.getVoidElements(),
            ...
            l = t.endOffset;
          return (
            _e(o, s.nodeName.toLowerCase())
              ? 0 === a
                ? r.setStartBefore(s)
                : r.setStartAfter(s)
              : r.setStart(s, a),
            _e(o, i.nodeName.toLowerCase())
              ? 0 === l
                ? r.setEndBefore(i)
                : r.setEndAfter(i)
              : r.setEnd(i, l),
          ...
          e.on("mousedown", (r) => {
            ...
            RT(a)
              ...
              : cT(o, r.clientX, r.clientY).each((n) => {
                  var o;
                  r.preventDefault(),
                    (o = d(1, n.node, n.position === rT.Before, !1)) &&
                      t.setRng(o),
                  ...
                  const t = (t) => {
                      if (!t.isDefaultPrevented()) {
                        ...
                        n &&
                          ...
                          (t.preventDefault(),
                          "drop" === t.type &&
                            uE(e, "Dropped file type is not supported"));
                      }
                    },
                    n = (n) => {
                      mg(e, n.target) && t(n);
    ...
    OT = (e, t) => {
      let n = t;
      for (let t = e.previousSibling; es(t); t = t.previousSibling)
        n += t.data.length;
      return n;
    },
    BT = (e, t, n, o, r) => {
    ...
    UT = (e, t, n) => {
      ...
      return {
        ...e,
        blockPatterns: rd(o).concat(e.blockPatterns),
        inlinePatterns: sd(o).concat(e.inlinePatterns),
      };
    },
    zT = (e, t, n, o) => {
      const r = e.createRng();
    ...
    QT = (e, t, n) =>
      ((e, t, n) => {
        ...
        {
          const t = Ei(jk);
          return I.from(t.forwards(e, 0, Hk(e), n)).map((e) =>
            zk(e.container, 0)
          );
        }
      })(t, 0, t).map((o) => {
    ...
    dO = (e) => {
                ...
                ((e, t) => {
                  ...
                  return FT(e, n)
                    .map((o) => {
                      ...
                      return {
                        inlineMatches: GT(e, o, n.startContainer, s, a, !0),
                        blockMatches: rO(e, o, a, !0),
                      };
                    })
                    .filter(
      ...
      e.on("keyup", (e) => {
        ...
        e.on("keypress", (n) => {
          lO(t, n, (e, t) => e.charCodeAt(0) === t.charCode) &&
            sg.setEditorTimeout(e, s);
        });
    },
    cO = (e) => {
      const t = an.each,
      ...
      const a = Promise.all(
          ((e, t, n) => {
            const { pass: o, fail: r } = K(t, (e) =>
                tinymce.Resource.has(_E(e))
              ),
              s = o.map((t) => {
                const n = tinymce.Resource.get(_E(t));
                return m(n)
                  ? Promise.resolve(hO(e).loadRawCss(t, n))
                  : Promise.resolve();
              }),
              a = [...s, hO(e).loadAll(r)];
    ...
    vO = (e) => {
      !0 !== e.removed &&
        (((e) => {
          kw(e) || e.load({ initial: !0, format: "html" }),
    ...
    yO = (e) => {
      ...
      (o.disabled = !0),
        ...
        !hu(e) &&
          e.hasEditableRoot() &&
          (e.inline &&
            "static" === uO.getStyle(o, "position", !0) &&
            ...
            s = (t, a) => {
              ...
              const i = e.getBody(),
                l =
                  !((e) =>
                    YE(e) &&
                    !(XE(e) || ("keyup" === e.type && 229 === e.keyCode)))(t) &&
                  ((e, t, n) => {
                    if (
      ...
      ((e) => {
        ...
        ((e) => {
          ...
          Fc(e) ||
            ((t.body.spellcheck = !1), uO.setAttrib(n, "spellcheck", "false")),
          (e.quirks = cO(e)),
          ((e) => {
        ...
        ((e) => {
          ...
          m(pu(e)) ||
            (!v(t) &&
              "INVALID" !=
                (((e) => "gpl" === e.toLowerCase())((n = t)) ||
                ((e) => e.length >= 64 && e.length <= 255)(n)
                  ? "VALID"
                  : "INVALID")) ||
            console.warn(
    ...
    _O = async (e) => {
          ...
          if (m(t)) {
            ...
            (e.theme = n(e, lE.urls[t]) || {}),
              w(e.theme.init) &&
                e.theme.init(
                  e,
                  lE.urls[t] || e.documentBaseUrl.replace(/\/$/, "")
                );
          } else e.theme = {};
        })(e),
        ((e) => {
            ...
            ((e, t, n) => {
              ...
              if (((n = an.trim(n)), o && -1 === an.inArray(t, n))) {
                ...
                try {
                  ...
                  ((e, t, n) => {
                    const o = li.translate([
                      "Failed to initialize plugin: {0}",
                      t,
                    ]);
                    ld(e, "PluginLoadError", { message: o }),
                      gE(o, n),
                      uE(e, o);
                  })(e, n, t);
                }
      ...
      ((e, t) => {
        const n = {
          ...
          setEnabled: (n) => {
            (n && ("readonly" === e.mode.get() || yE(e))) ||
              I.from(t.setEnabled).each((e) => e(n));
          },
        };
        e.ui = { ...e.ui, ...n };
          ...
          : ((e, t) => {
              ((e, t) => {
                ...
                t.editorContainer &&
                  ...
                  (e.hidden = CO.isHidden(t.editorContainer))),
    ...
    IO = (e, t, n, o, r) => {
      var s;
      const a = e
          ? { mobile: LO(null !== (s = r.mobile) && void 0 !== s ? s : {}, t) }
          : {},
        i = PO(["mobile"], Me(a, r)),
        l = an.extend(
          n,
      ...
      return ((e, t, n, o) => {
        const r = BO(n.forced_plugins),
          ...
          i = ((e, t, n, o) => (e && DO(t, "mobile") ? o : n))(
            e,
            t,
            s,
            a.plugins ? BO(a.plugins) : s
          ),
          l = ((e, t) => [...BO(e), ...BO(t)])(r, i);
    ...
    zO = (e, t) => {
      if (e.selection.isEditable()) {
        ...
        ZC(e, {
          ...
          const n = ((e, t, n) => Nw(e).editor.insertContent(t, n))(
            e,
            t.content,
            o
          );
          ...
          ((e, t, n) =>
            xr(
              ...
              (t) =>
                ((t) =>
                  Io(t, e).orThunk(() =>
                    HO(t) ? xe(jO, e).bind((e) => bo(t, e)) : I.none()
                  ))(t),
              (e) => Cn(mn(t), e)
            ))(e, t, n.dom).or(
            ((e, t) => I.from(ni.DOM.getStyle(t, e, !0)))(e, n.dom)
          )
        )
        .getOr(""),
    VO = $O("font-size"),
    ...
    YO = (e, t) => {
      if (/^[0-9.]+$/.test(t)) {
        ...
        if (n >= 1 && n <= 7) {
          const o = ((e) =>
              an.explode(e.options.get("font_size_style_values")))(e),
          ...
          ((e) => {
            ...
            e.editorCommands.addCommands({
              ...
              FontName: (t, n, o) => {
                ((e, t) => {
                  const n = YO(e, t);
                  e.formatter.toggle("fontname", { value: XO(n) }),
                    e.nodeChanged();
                })(e, o);
              },
              FontSize: (t, n, o) => {
                ((e, t) => {
                  e.formatter.toggle("fontsize", { value: YO(e, t) }),
                    e.nodeChanged();
                })(e, o);
              },
              LineHeight: (t, n, o) => {
                ...
                e.removed ||
                  (t
                    ...
                    : ((e) => {
                        ...
                        e.inline ||
                          (nn.browser.isOpera() || bg(n), e.getWin().focus()),
                          (nn.browser.isFirefox() || e.inline) &&
                            (bg(n), hg(e, o)),
                          Cg(e);
                      })(e));
              })(e, !0 === o);
  ...
  class eB {
    ...
    queryCommandState(e) {
      if ((!JO(e) && this.editor.quirks.isHidden()) || this.editor.removed)
        return !1;
      const t = e.toLowerCase(),
    ...
    rB = {
      ...
      dispatch(e, t, n) {
        ...
        if (o.removed && "remove" !== e && "detach" !== e)
          return za(e.toLowerCase(), null != t ? t : {}, o);
  ...
  const iB = (e, t) => {
      ...
      const n = sc(e);
      return n
        ? (e.eventRoot || (e.eventRoot = sB.select(n)[0]), e.eventRoot)
        : e.getBody();
    },
    lB = (e, t, n) => {
      ((e) => !e.hidden && !yE(e))(e)
        ...
        : yE(e) &&
          ((e, t) => {
            if (((e) => "click" === e.type)(t) && !wg.metaKeyPressed(t)) {
              const n = mn(t.target);
              ((e, t) =>
                sr(t, "a", (t) => Cn(t, mn(e.getBody()))).bind((e) =>
                  bo(e, "href")
                ))(e, n).each((n) => {
        ...
        "focus" !== e &&
          ...
          (n.removed ||
            (t
              ...
              : n.initialized &&
                n.delegates &&
                (n.dom.unbind(iB(n, e), e, n.delegates[e]),
          ...
          const t = (t) => {
              pB(e) &&
                ((e) =>
                  $(
                    e,
                    (e) => "characterData" === e.type || "childList" === e.type
                  ))(t) &&
                ((e) => {
      ...
      yB(CB(e.toLowerCase(), "+"), (e) => {
        ((e) => e in EB)(e)
          ...
          : ((t.charCode = e.charCodeAt(0)),
            (t.keyCode = wB[e] || e.toUpperCase().charCodeAt(0)));
      });
      const o = [t.keyCode];
      let r;
  ...
  class _B {
    ...
    createShortcut(e, t, n, o) {
      ...
      return (
        (r[r.length - 1] = an.extend(r[r.length - 1], {
          func: n,
          scope: o || this.editor,
        })),
        an.extend(r[0], {
  ...
  class AB {
    constructor(e, t, n) {
        ...
        const o = {},
          ...
          s = (e, t, n) => {
            ...
            return fB(o)
              ? ((r[e] = o.value), !0)
              : (console.warn(
                  mB(`Invalid value passed for the ${e} option`, o)
                ),
                !1);
          },
          a = (e) => _e(o, e);
            ...
            const a = ((e) => m(e.processor))(n)
              ...
              i = ((e, t, n) => {
                if (!v(t)) {
                  ...
                  console.error(
                    mB(`Invalid default value passed for the "${e}" option`, o)
                  );
                }
              })(e, n.default, a);
        ...
        ((e) => {
          ...
          t("id", { processor: "string", default: e.id }),
            ...
            e.on("ScriptsLoaded", () => {
              t("directionality", {
                processor: "string",
                default: li.isRtl() ? "rtl" : void 0,
              }),
                t("placeholder", {
                  processor: "string",
                  default: bd.getAttrib(e.getElement(), "placeholder"),
                });
            });
        })(o);
      ...
      const l = Wd(o);
      l &&
        (ri.ScriptLoader._setReferrerPolicy(l),
        ni.DOM.styleSheetLoader._setReferrerPolicy(l));
      const d = kc(o);
      ...
      ((e) => {
        ...
        e.on("remove", () => {
          ...
          (e.ui.styleSheetLoader = ((e, t) =>
            Ys.forElement(e, { contentCssCors: kc(t), referrerPolicy: Wd(t) }))(
            o,
            e
          )),
          bc(e)
        ...
        s &&
          ...
          vc(e) &&
            !Jr(e.getElement()) &&
            (SO.insertAfter(SO.create("input", { type: "hidden", name: t }), t),
            (e.hasHiddenInput = !0)),
    ...
    show() {
      ...
      e.hidden &&
        ...
        e.inline
          ...
          : (kB.show(e.getContainer()), kB.hide(e.id)),
        e.load(),
        e.dispatch("show"));
    }
    hide() {
      ...
      e.hidden ||
        ...
        e.inline
          ...
          : (kB.hide(e.getContainer()),
            kB.setStyle(e.id, "display", e.orgDisplay)),
        (e.hidden = !0),
        e.dispatch("hide"));
    }
    isHidden() {
    ...
    resetContent(e) {
      void 0 === e
        ? Fw(this, this.startContent, { format: "raw" })
        : Fw(this, e),
    ...
    getContainer() {
      ...
      return (
        e.container ||
          (e.container = e.editorContainer || kB.get(e.id + "_parent")),
        e.container
      );
    }
    ...
    getElement() {
      return (
        this.targetElm || (this.targetElm = kB.get(this.id)), this.targetElm
      );
    }
    getWin() {
      const e = this;
  ...
  const LB = (e) => {
    ...
    IB = (e) => {
      ...
      return (
        (DB = Y(DB, (t) => e !== t)),
        UB.activeEditor === e &&
          (UB.activeEditor = DB.length > 0 ? DB[0] : null),
            ...
            return (
              ...
              h(t.get(n.id))
                ...
                : (IB(n) && t.dispatch("RemoveEditor", { editor: n }),
                  0 === DB.length &&
                    window.removeEventListener("beforeunload", BB),
                  n.remove(),
                  MB(DB.length > 0),
                  n)
            );
              ...
              const i = ((e, t, n = 1e3) => {
                ...
                return {
                  start: (...e) => {
                    o ||
                      null !== r ||
                      (r = window.setTimeout(() => i.apply(null, e), n));
                  },
                  resolve: a,
                  reject: i,
                };
